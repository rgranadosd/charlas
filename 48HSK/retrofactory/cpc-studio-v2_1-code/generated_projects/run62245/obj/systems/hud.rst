                             ...
                             21 ;--------------------------------------------------------
                             22 	.area _DATA
   639F                      23 _currenthealth:
   639F                      24 	.ds 1
   63A0                      25 _currentscore:
   63A0                      26 	.ds 2
   63A2                      27 _currenttime:
   63A2                      28 	.ds 1
   63A3                      29 _currentlives:
   63A3                      30 	.ds 1
   63A4                      31 _currentweapon:
   63A4                      32 	.ds 1
                             33 ;--------------------------------------------------------
                             34 ; ram data
                             35 ;--------------------------------------------------------
   ...
   4D2D 33            [ 6]   70 	inc	sp
   4D2E CD A4 61      [17]   71 	call	__moduchar
   ...
   4F38 CD 25 60      [17]  572 	call	__divuint
   ...
   4F49 CD B0 61      [17]  584 	call	__moduint
   ...
   4F6E CD CE 62      [17]  608 	call	_cpct_getScreenPtr
   ...
   4F8A CD FF 60      [17]  629 	call	_cpct_drawSprite
   ...
   4F9B CD 25 60      [17]  641 	call	__divuint
   ...
   4FF4 32 A4 63      [13]  708 	ld	(#_currentweapon + 0),a
   4FF7 C9            [10]  709 	ret
   ...
   4FFA                     717 00103$:
   4FFA 21 9F 63      [10]  718 	ld	hl, #_currenthealth
   ...
   5012 CD CE 62      [17]  736 	call	_cpct_getScreenPtr
   ...
   501E CD FF 60      [17]  742 	call	_cpct_drawSprite
   ...
   5025 2A A0 63      [16]  749 	ld	hl, (_currentscore)
   ...
   5037 21 A2 63      [10]  762 	ld	hl,#_currenttime + 0
   ...
   5053 CD CE 62      [17]  780 	call	_cpct_getScreenPtr
   ...
   505F CD FF 60      [17]  787 	call	_cpct_drawSprite
   ...
   506A CD CE 62      [17]  793 	call	_cpct_getScreenPtr
   ...
   5072 3A A3 63      [13]  799 	ld	a, (_currentlives)
   5075 F5            [11]  800 	push	af
   5076 33            [ 6]  801 	inc	sp
   5077 CD A4 61      [17]  802 	call	__moduchar
   ...
   5089 CD FF 60      [17]  814 	call	_cpct_drawSprite
   ...
   5094 CD CE 62      [17]  820 	call	_cpct_getScreenPtr
   ...
   509C 3A A4 63      [13]  826 	ld	a, (_currentweapon)
   509F F5            [11]  827 	push	af
   50A0 33            [ 6]  828 	inc	sp
   50A1 CD A4 61      [17]  829 	call	__moduchar
   ...
   50B3 CD FF 60      [17]  841 	call	_cpct_drawSprite
   50B6 C9            [10]  842 	ret
                            843 	.area _CODE
