...
;src/entities/enemy.c:116: return;
	jr	Z,00113$
;src/entities/enemy.c:119: if (enemy->kind == 3) colour = 0x4C;
	push	bc
	pop	iy
	ld	a, 9 (iy)
	cp	a, #0x03
	...
	jr	00112$
00111$:
;src/entities/enemy.c:120: else if (enemy->kind == 2) colour = 0x5A;
	cp	a, #0x02
	jr	NZ,00108$
	ld	e, #0x5a
	jr	00112$
00108$:
;src/entities/enemy.c:121: else if (enemy->kind == 1) colour = 0x4E;
	dec	a
	jr	NZ,00105$
	ld	e, #0x4e
	jr	00112$
00105$:
;src/entities/enemy.c:122: else colour = 0x5C;
	ld	e, #0x5c
00112$:
