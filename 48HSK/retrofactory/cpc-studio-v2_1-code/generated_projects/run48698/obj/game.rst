   ...
   678B                      62 _g_timeleft:
   678B                      63 	.ds 1
   678C                      64 _g_weapondisplay:
   678C                      65 	.ds 1
   678D                      66 _g_currentwave:
   678D                      67 	.ds 1
   678E                      68 _g_aliveenemies:
   678E                      69 	.ds 1
   678F                      70 _g_wavecooldown:
   678F                      71 	.ds 1
   6790                      72 _g_damagecooldown:
   6790                      73 	.ds 1
   6791                      74 _g_shootcooldown:
   6791                      75 	.ds 1
   6792                      76 _g_victory:
   6792                      77 	.ds 1
   6793                      78 _g_gameover:
   6793                      79 	.ds 1
   6794                      80 _g_framecounter:
   6794                      81 	.ds 2
   6796                      82 _g_checkpointx:
   6796                      83 	.ds 1
   6797                      84 _g_checkpointy:
   6797                      85 	.ds 1
   6798                      86 _g_checkpointactive:
   6798                      87 	.ds 1
   6799                      88 _g_boss:
   6799                      89 	.ds 10
   67A3                      90 _g_bossactive:
   67A3                      91 	.ds 1
   67A4                      92 _g_bossphase:
   67A4                      93 	.ds 1
   67A5                      94 _g_weaponlevel:
   67A5                      95 	.ds 1
   67A6                      96 _g_pickuptaken:
   67A6                      97 	.ds 1
                             98 ;--------------------------------------------------------
                             99 ; ram data
                            100 ;--------------------------------------------------------
   ...
   4000 21 06 67      [10]  128 	ld	hl, #_g_player
   4003 3A 96 67      [13]  129 	ld	a,(#_g_checkpointx + 0)
   4006 77            [ 7]  130 	ld	(hl), a
                            131 ;src/game.c:43: g_player.y = g_checkpointy;
   4007 21 07 67      [10]  132 	ld	hl, #(_g_player + 0x0001)
   400A 3A 97 67      [13]  133 	ld	a,(#_g_checkpointy + 0)
   400D 77            [ 7]  134 	ld	(hl), a
                            135 ;src/game.c:44: g_player.vx = 0;
   400E 21 08 67      [10]  136 	ld	hl, #(_g_player + 0x0002)
   4011 36 00         [10]  137 	ld	(hl), #0x00
                            138 ;src/game.c:45: g_player.vy = 0;
   4013 21 09 67      [10]  139 	ld	hl, #(_g_player + 0x0003)
   ...
   40B1 01 10 67      [10]  235 	ld	bc, #_g_enemies+0
   ...
   40C4 CD 75 58      [17]  252 	call	_enemyinit
   ...
   4101                     294 00148$:
   4101 DD 73 FD      [19]  295 	ld	-3 (ix), e
   ...
   411A DD 7E FD      [19]  309 	ld	a, -3 (ix)
   ...
   4152 DD 36 FF 01   [19]  347 	ld	-1 (ix), #0x01
   4156 18 04         [12]  348 	jr	00134$
   4158                     349 00133$:
   4158 DD 36 FF 00   [19]  350 	ld	-1 (ix), #0x00
   415C                     351 00134$:
   ...
   417B DD 7E FF      [19]  373 	ld	a, -1 (ix)
   ...
   418C CD 30 5A      [17]  385 	call	_enemyspawn
   ...
   419E 32 8E 67      [13]  396 	ld	(#_g_aliveenemies + 0),a
   ...
   41A6 21 99 67      [10]  406 	ld	hl, #_g_boss
   41A9 E5            [11]  407 	push	hl
   41AA CD 75 58      [17]  408 	call	_enemyinit
   ...
   421F 11 4C 67      [10]  487 	ld	de, #_g_projectiles
   ...
   422B 3A A5 67      [13]  495 	ld	a,(#_g_weaponlevel + 0)
   ...
   423B                     502 00115$:
   423B 3A 07 67      [13]  503 	ld	a, (#_g_player + 1)
   423E C6 06         [ 7]  504 	add	a, #0x06
   4240 DD 77 FD      [19]  505 	ld	-3 (ix), a
   4243 21 06 67      [10]  506 	ld	hl, #_g_player + 0
   ...
   4254 11 4C 67      [10]  518 	ld	de, #_g_projectiles
   ...
   4269 CD 8E 62      [17]  533 	call	_projectilefire
   ...
   4271 3A A5 67      [13]  538 	ld	a,(#_g_weaponlevel + 0)
   ...
   427D                     545 00117$:
   427D 21 91 67      [10]  546 	ld	hl,#_g_shootcooldown + 0
   ...
   4291 FD 21 88 67   [14]  567 	ld	iy, #_g_lives
   ...
   42AD 21 90 67      [10]  587 	ld	hl,#_g_damagecooldown + 0
   ...
   42D0 CD FB 64      [17]  614 	call	_cpct_setPALColour
   ...
   42FB 11 4C 67      [10]  646 	ld	de, #_g_projectiles
   42FE 19            [11]  647 	add	hl, de
   42FF C5            [11]  648 	push	bc
   4300 E5            [11]  649 	push	hl
   4301 CD 31 62      [17]  650 	call	_projectileinit
   ...
   43BB 21 06 67      [10]  756 	ld	hl, #_g_player
   43BE E5            [11]  757 	push	hl
   43BF CD 6C 5F      [17]  758 	call	_playerupdate
   ...
   43C6 FD 21 91 67   [14]  763 	ld	iy, #_g_shootcooldown
   ...
   43D3 FD 21 90 67   [14]  770 	ld	iy, #_g_damagecooldown
   ...
   43EA 11 4C 67      [10]  787 	ld	de, #_g_projectiles
   43ED 19            [11]  788 	add	hl, de
   43EE C5            [11]  789 	push	bc
   43EF E5            [11]  790 	push	hl
   43F0 CD 4C 63      [17]  791 	call	_projectileupdate
   ...
   4405 11 10 67      [10]  810 	ld	de, #_g_enemies
   4408 19            [11]  811 	add	hl, de
   4409 C5            [11]  812 	push	bc
   440A E5            [11]  813 	push	hl
   440B CD 08 5C      [17]  814 	call	_enemyupdate
   ...
   444E 21 99 67      [10]  851 	ld	hl, #_g_boss + 0
   ...
   4464 3A A4 67      [13]  862 	ld	a,(#_g_bossphase + 0)
   ...
   4475                     874 00183$:
   4475 3A A4 67      [13]  875 	ld	a,(#_g_bossphase + 0)
   ...
   4481                     882 00188$:
   4481                     883 00184$:
   4481 21 9B 67      [10]  884 	ld	hl, #(_g_boss + 0x0002)
   4484 71            [ 7]  885 	ld	(hl), c
                            886 ;src/game.c:196: enemyupdate(&g_boss);
   4485 21 99 67      [10]  887 	ld	hl, #_g_boss
   4488 E5            [11]  888 	push	hl
   4489 CD 08 5C      [17]  889 	call	_enemyupdate
   ...
   4498 21 4C 67      [10]  904 	ld	hl, #_g_projectiles
   ...
   44BD 3E 10         [ 7]  928 	ld	a, #<(_g_enemies)
   44BF 85            [ 4]  929 	add	a, l
   44C0 DD 77 EB      [19]  930 	ld	-21 (ix), a
   44C3 3E 67         [ 7]  931 	ld	a, #>(_g_enemies)
   44C5 8C            [ 4]  932 	adc	a, h
   44C6 DD 77 EC      [19]  933 	ld	-20 (ix), a
   44C9 DD 6E EB      [19]  934 	ld	l,-21 (ix)
   44CC DD 66 EC      [19]  935 	ld	h,-20 (ix)
   ...
   44DA DD 75 F5      [19]  944 	ld	-11 (ix), l
   44DD DD 74 F6      [19]  945 	ld	-10 (ix), h
   44E0 21 04 00      [10]  946 	ld	hl, #0x0004
   44E3 19            [11]  947 	add	hl,de
   44E4 DD 75 F3      [19]  948 	ld	-13 (ix), l
   44E7 DD 74 F4      [19]  949 	ld	-12 (ix), h
   44EA 21 01 00      [10]  950 	ld	hl, #0x0001
   44ED 19            [11]  951 	add	hl,de
   44EE DD 75 F1      [19]  952 	ld	-15 (ix), l
   44F1 DD 74 F2      [19]  953 	ld	-14 (ix), h
   ...
   44F8 DD 75 FA      [19]  957 	ld	-6 (ix), l
   44FB DD 74 FB      [19]  958 	ld	-5 (ix), h
   ...
   4503 DD 6E EB      [19]  964 	ld	l,-21 (ix)
   4506 DD 66 EC      [19]  965 	ld	h,-20 (ix)
   ...
   450F DD 77 FC      [19]  972 	ld	-4 (ix), a
   4512 DD 6E EB      [19]  973 	ld	l,-21 (ix)
   4515 DD 66 EC      [19]  974 	ld	h,-20 (ix)
   4518 23            [ 6]  975 	inc	hl
   4519 23            [ 6]  976 	inc	hl
   451A 23            [ 6]  977 	inc	hl
   451B 23            [ 6]  978 	inc	hl
   451C 7E            [ 7]  979 	ld	a, (hl)
   451D DD 77 F9      [19]  980 	ld	-7 (ix), a
   4520 DD 6E EB      [19]  981 	ld	l,-21 (ix)
   4523 DD 66 EC      [19]  982 	ld	h,-20 (ix)
   4526 23            [ 6]  983 	inc	hl
   4527 46            [ 7]  984 	ld	b, (hl)
   4528 DD 70 F7      [19]  985 	ld	-9 (ix), b
   452B DD 36 F8 00   [19]  986 	ld	-8 (ix), #0x00
   452F DD 6E EB      [19]  987 	ld	l,-21 (ix)
   4532 DD 66 EC      [19]  988 	ld	h,-20 (ix)
   4535 46            [ 7]  989 	ld	b, (hl)
   4536 DD 70 FE      [19]  990 	ld	-2 (ix), b
   4539 DD 36 FF 00   [19]  991 	ld	-1 (ix), #0x00
                            992 ;src/game.c:203: if (!rect_overlap((i16)g_projectiles[i].x, (i16)g_projectiles[i].y, g_projectiles[i].w, g_projectiles[i].h,
   453D DD 6E F5      [19]  993 	ld	l,-11 (ix)
   4540 DD 66 F6      [19]  994 	ld	h,-10 (ix)
   4543 7E            [ 7]  995 	ld	a, (hl)
   4544 DD 77 FD      [19]  996 	ld	-3 (ix), a
   4547 DD 6E F3      [19]  997 	ld	l,-13 (ix)
   454A DD 66 F4      [19]  998 	ld	h,-12 (ix)
   454D 46            [ 7]  999 	ld	b, (hl)
   454E DD 6E F1      [19] 1000 	ld	l,-15 (ix)
   4551 DD 66 F2      [19] 1001 	ld	h,-14 (ix)
   4554 6E            [ 7] 1002 	ld	l, (hl)
   4555 DD 75 EF      [19] 1003 	ld	-17 (ix), l
   4558 DD 36 F0 00   [19] 1004 	ld	-16 (ix), #0x00
   455C 1A            [ 7] 1005 	ld	a, (de)
   455D DD 77 ED      [19] 1006 	ld	-19 (ix), a
   4560 DD 36 EE 00   [19] 1007 	ld	-18 (ix), #0x00
   4564 C5            [11] 1008 	push	bc
   4565 D5            [11] 1009 	push	de
   4566 DD 66 FC      [19] 1010 	ld	h, -4 (ix)
   4569 DD 6E F9      [19] 1011 	ld	l, -7 (ix)
   456C E5            [11] 1012 	push	hl
   456D DD 6E F7      [19] 1013 	ld	l,-9 (ix)
   4570 DD 66 F8      [19] 1014 	ld	h,-8 (ix)
   4573 E5            [11] 1015 	push	hl
   4574 DD 6E FE      [19] 1016 	ld	l,-2 (ix)
   4577 DD 66 FF      [19] 1017 	ld	h,-1 (ix)
   457A E5            [11] 1018 	push	hl
   457B DD 7E FD      [19] 1019 	ld	a, -3 (ix)
   457E F5            [11] 1020 	push	af
   457F 33            [ 6] 1021 	inc	sp
   4580 C5            [11] 1022 	push	bc
   4581 33            [ 6] 1023 	inc	sp
   4582 DD 6E EF      [19] 1024 	ld	l,-17 (ix)
   4585 DD 66 F0      [19] 1025 	ld	h,-16 (ix)
   4588 E5            [11] 1026 	push	hl
   4589 DD 6E ED      [19] 1027 	ld	l,-19 (ix)
   458C DD 66 EE      [19] 1028 	ld	h,-18 (ix)
   ...
   45A1 DD 6E FA      [19] 1040 	ld	l,-6 (ix)
   45A4 DD 66 FB      [19] 1041 	ld	h,-5 (ix)
   45A7 66            [ 7] 1042 	ld	h, (hl)
   45A8 DD 6E EB      [19] 1043 	ld	l, -21 (ix)
   45AB DD 46 EC      [19] 1044 	ld	b, -20 (ix)
   ...
   45B4 CD A6 5E      [17] 1051 	call	_enemydamage
   ...
   45BF DD 6E EB      [19] 1060 	ld	l,-21 (ix)
   45C2 DD 66 EC      [19] 1061 	ld	h,-20 (ix)
   ...
   45CC DD 75 ED      [19] 1067 	ld	-19 (ix), l
   45CF DD 36 EE 00   [19] 1068 	ld	-18 (ix), #0x00
   45D3 21 89 67      [10] 1069 	ld	hl, #_g_score
   45D6 7E            [ 7] 1070 	ld	a, (hl)
   45D7 DD 86 ED      [19] 1071 	add	a, -19 (ix)
   45DA 77            [ 7] 1072 	ld	(hl), a
   45DB 23            [ 6] 1073 	inc	hl
   45DC 7E            [ 7] 1074 	ld	a, (hl)
   45DD DD 8E EE      [19] 1075 	adc	a, -18 (ix)
   45E0 77            [ 7] 1076 	ld	(hl), a
                           1077 ;src/game.c:207: if (g_aliveenemies) g_aliveenemies--;
   45E1 FD 21 8E 67   [14] 1078 	ld	iy, #_g_aliveenemies
   ...
   45F8 DD 34 E8      [23] 1092 	inc	-24 (ix)
   45FB DD 7E E8      [19] 1093 	ld	a, -24 (ix)
   ...
   4603 3A A3 67      [13] 1098 	ld	a,(#_g_bossactive + 0)
   ...
   4615 21 9E 67      [10] 1107 	ld	hl, #(_g_boss + 0x0005) + 0
   4618 46            [ 7] 1108 	ld	b, (hl)
   4619 3A 9D 67      [13] 1109 	ld	a, (#(_g_boss + 0x0004) + 0)
   461C 21 9A 67      [10] 1110 	ld	hl, #(_g_boss + 0x0001) + 0
   461F 6E            [ 7] 1111 	ld	l, (hl)
   4620 DD 75 ED      [19] 1112 	ld	-19 (ix), l
   4623 DD 36 EE 00   [19] 1113 	ld	-18 (ix), #0x00
   4627 21 99 67      [10] 1114 	ld	hl, #_g_boss + 0
   462A 6E            [ 7] 1115 	ld	l, (hl)
   462B DD 75 EF      [19] 1116 	ld	-17 (ix), l
   462E DD 36 F0 00   [19] 1117 	ld	-16 (ix), #0x00
   ...
   4632 DD 6E F5      [19] 1119 	ld	l,-11 (ix)
   4635 DD 66 F6      [19] 1120 	ld	h,-10 (ix)
   4638 F5            [11] 1121 	push	af
   4639 7E            [ 7] 1122 	ld	a, (hl)
   463A DD 77 FD      [19] 1123 	ld	-3 (ix), a
   463D F1            [10] 1124 	pop	af
   463E DD 6E F3      [19] 1125 	ld	l,-13 (ix)
   4641 DD 66 F4      [19] 1126 	ld	h,-12 (ix)
   4644 F5            [11] 1127 	push	af
   4645 7E            [ 7] 1128 	ld	a, (hl)
   4646 DD 77 FE      [19] 1129 	ld	-2 (ix), a
   4649 F1            [10] 1130 	pop	af
   464A DD 6E F1      [19] 1131 	ld	l,-15 (ix)
   464D DD 66 F2      [19] 1132 	ld	h,-14 (ix)
   4650 6E            [ 7] 1133 	ld	l, (hl)
   4651 DD 75 F7      [19] 1134 	ld	-9 (ix), l
   4654 DD 36 F8 00   [19] 1135 	ld	-8 (ix), #0x00
   ...
   4663 DD 6E ED      [19] 1146 	ld	l,-19 (ix)
   4666 DD 66 EE      [19] 1147 	ld	h,-18 (ix)
   4669 E5            [11] 1148 	push	hl
   466A DD 6E EF      [19] 1149 	ld	l,-17 (ix)
   466D DD 66 F0      [19] 1150 	ld	h,-16 (ix)
   4670 E5            [11] 1151 	push	hl
   4671 DD 66 FD      [19] 1152 	ld	h, -3 (ix)
   4674 DD 6E FE      [19] 1153 	ld	l, -2 (ix)
   4677 E5            [11] 1154 	push	hl
   4678 DD 6E F7      [19] 1155 	ld	l,-9 (ix)
   467B DD 66 F8      [19] 1156 	ld	h,-8 (ix)
   ...
   4698 DD 6E FA      [19] 1172 	ld	l,-6 (ix)
   469B DD 66 FB      [19] 1173 	ld	h,-5 (ix)
   469E 46            [ 7] 1174 	ld	b, (hl)
   469F 11 99 67      [10] 1175 	ld	de, #_g_boss
   46A2 C5            [11] 1176 	push	bc
   46A3 C5            [11] 1177 	push	bc
   46A4 33            [ 6] 1178 	inc	sp
   46A5 D5            [11] 1179 	push	de
   46A6 CD A6 5E      [17] 1180 	call	_enemydamage
   ...
   46C5 21 92 67      [10] 1203 	ld	hl,#_g_victory + 0
   ...
   46E9 21 10 67      [10] 1230 	ld	hl, #_g_enemies
   46EC 09            [11] 1231 	add	hl,bc
   46ED DD 75 ED      [19] 1232 	ld	-19 (ix), l
   46F0 DD 74 EE      [19] 1233 	ld	-18 (ix), h
   ...
   46FC DD 7E ED      [19] 1240 	ld	a, -19 (ix)
   46FF DD 77 EF      [19] 1241 	ld	-17 (ix), a
   4702 DD 7E EE      [19] 1242 	ld	a, -18 (ix)
   4705 DD 77 F0      [19] 1243 	ld	-16 (ix), a
   4708 DD 6E EF      [19] 1244 	ld	l,-17 (ix)
   470B DD 66 F0      [19] 1245 	ld	h,-16 (ix)
   470E 11 05 00      [10] 1246 	ld	de, #0x0005
   4711 19            [11] 1247 	add	hl, de
   4712 7E            [ 7] 1248 	ld	a, (hl)
   4713 DD 77 EF      [19] 1249 	ld	-17 (ix), a
   4716 DD 6E ED      [19] 1250 	ld	l,-19 (ix)
   4719 DD 66 EE      [19] 1251 	ld	h,-18 (ix)
   471C 11 04 00      [10] 1252 	ld	de, #0x0004
   471F 19            [11] 1253 	add	hl, de
   4720 5E            [ 7] 1254 	ld	e, (hl)
   4721 DD 6E ED      [19] 1255 	ld	l,-19 (ix)
   4724 DD 66 EE      [19] 1256 	ld	h,-18 (ix)
   4727 23            [ 6] 1257 	inc	hl
   4728 4E            [ 7] 1258 	ld	c, (hl)
   4729 06 00         [ 7] 1259 	ld	b, #0x00
   472B DD 6E ED      [19] 1260 	ld	l,-19 (ix)
   472E DD 66 EE      [19] 1261 	ld	h,-18 (ix)
   4731 56            [ 7] 1262 	ld	d, (hl)
   4732 DD 72 ED      [19] 1263 	ld	-19 (ix), d
   4735 DD 36 EE 00   [19] 1264 	ld	-18 (ix), #0x00
                           1265 ;src/game.c:227: if (rect_overlap((i16)g_player.x, (i16)g_player.y, g_player.w, g_player.h,
   4739 3A 0B 67      [13] 1266 	ld	a,(#(_g_player + 0x0005) + 0)
   473C DD 77 FD      [19] 1267 	ld	-3 (ix), a
   473F 3A 0A 67      [13] 1268 	ld	a,(#(_g_player + 0x0004) + 0)
   4742 DD 77 FE      [19] 1269 	ld	-2 (ix), a
   4745 3A 07 67      [13] 1270 	ld	a, (#(_g_player + 0x0001) + 0)
   4748 DD 77 F7      [19] 1271 	ld	-9 (ix), a
   474B DD 36 F8 00   [19] 1272 	ld	-8 (ix), #0x00
   474F 3A 06 67      [13] 1273 	ld	a, (#_g_player + 0)
   4752 DD 77 FA      [19] 1274 	ld	-6 (ix), a
   4755 DD 36 FB 00   [19] 1275 	ld	-5 (ix), #0x00
   4759 DD 56 EF      [19] 1276 	ld	d, -17 (ix)
   475C D5            [11] 1277 	push	de
   475D C5            [11] 1278 	push	bc
   475E DD 6E ED      [19] 1279 	ld	l,-19 (ix)
   4761 DD 66 EE      [19] 1280 	ld	h,-18 (ix)
   4764 E5            [11] 1281 	push	hl
   4765 DD 66 FD      [19] 1282 	ld	h, -3 (ix)
   4768 DD 6E FE      [19] 1283 	ld	l, -2 (ix)
   476B E5            [11] 1284 	push	hl
   476C DD 6E F7      [19] 1285 	ld	l,-9 (ix)
   476F DD 66 F8      [19] 1286 	ld	h,-8 (ix)
   4772 E5            [11] 1287 	push	hl
   4773 DD 6E FA      [19] 1288 	ld	l,-6 (ix)
   4776 DD 66 FB      [19] 1289 	ld	h,-5 (ix)
   ...
   478E DD 34 E7      [23] 1304 	inc	-25 (ix)
   4791 DD 7E E7      [19] 1305 	ld	a, -25 (ix)
   ...
   4799 3A 90 67      [13] 1310 	ld	a,(#_g_damagecooldown + 0)
   479C B7            [ 4] 1311 	or	a, a
   479D 20 6E         [12] 1312 	jr	NZ,00142$
   479F 3A A3 67      [13] 1313 	ld	a,(#_g_bossactive + 0)
   47A2 B7            [ 4] 1314 	or	a, a
   47A3 28 68         [12] 1315 	jr	Z,00142$
                           1316 ;src/game.c:235: (i16)g_boss.x, (i16)g_boss.y, g_boss.w, g_boss.h)) {
   47A5 3A 9E 67      [13] 1317 	ld	a,(#(_g_boss + 0x0005) + 0)
   47A8 DD 77 ED      [19] 1318 	ld	-19 (ix), a
   47AB 3A 9D 67      [13] 1319 	ld	a,(#(_g_boss + 0x0004) + 0)
   47AE DD 77 EF      [19] 1320 	ld	-17 (ix), a
   47B1 21 9A 67      [10] 1321 	ld	hl, #(_g_boss + 0x0001) + 0
   47B4 5E            [ 7] 1322 	ld	e, (hl)
   47B5 16 00         [ 7] 1323 	ld	d, #0x00
   47B7 21 99 67      [10] 1324 	ld	hl, #_g_boss + 0
   ...
   47BD 3A 0B 67      [13] 1328 	ld	a,(#(_g_player + 0x0005) + 0)
   47C0 DD 77 FD      [19] 1329 	ld	-3 (ix), a
   47C3 3A 0A 67      [13] 1330 	ld	a,(#(_g_player + 0x0004) + 0)
   47C6 DD 77 FE      [19] 1331 	ld	-2 (ix), a
   47C9 3A 07 67      [13] 1332 	ld	a, (#(_g_player + 0x0001) + 0)
   47CC DD 77 F7      [19] 1333 	ld	-9 (ix), a
   47CF DD 36 F8 00   [19] 1334 	ld	-8 (ix), #0x00
   47D3 3A 06 67      [13] 1335 	ld	a, (#_g_player + 0)
   47D6 DD 77 FA      [19] 1336 	ld	-6 (ix), a
   47D9 DD 36 FB 00   [19] 1337 	ld	-5 (ix), #0x00
   47DD DD 66 ED      [19] 1338 	ld	h, -19 (ix)
   47E0 DD 6E EF      [19] 1339 	ld	l, -17 (ix)
   47E3 E5            [11] 1340 	push	hl
   47E4 D5            [11] 1341 	push	de
   47E5 C5            [11] 1342 	push	bc
   47E6 DD 66 FD      [19] 1343 	ld	h, -3 (ix)
   47E9 DD 6E FE      [19] 1344 	ld	l, -2 (ix)
   47EC E5            [11] 1345 	push	hl
   47ED DD 6E F7      [19] 1346 	ld	l,-9 (ix)
   47F0 DD 66 F8      [19] 1347 	ld	h,-8 (ix)
   47F3 E5            [11] 1348 	push	hl
   47F4 DD 6E FA      [19] 1349 	ld	l,-6 (ix)
   47F7 DD 66 FB      [19] 1350 	ld	h,-5 (ix)
   ...
   480D 3A 90 67      [13] 1363 	ld	a,(#_g_damagecooldown + 0)
   4810 B7            [ 4] 1364 	or	a, a
   4811 20 31         [12] 1365 	jr	NZ,00149$
   4813 3A 0B 67      [13] 1366 	ld	a, (#(_g_player + 0x0005) + 0)
   4816 21 0A 67      [10] 1367 	ld	hl, #(_g_player + 0x0004) + 0
   4819 56            [ 7] 1368 	ld	d, (hl)
   481A 21 07 67      [10] 1369 	ld	hl, #(_g_player + 0x0001) + 0
   481D 4E            [ 7] 1370 	ld	c, (hl)
   481E 06 00         [ 7] 1371 	ld	b, #0x00
   4820 21 06 67      [10] 1372 	ld	hl, #_g_player + 0
   4823 6E            [ 7] 1373 	ld	l, (hl)
   4824 DD 75 ED      [19] 1374 	ld	-19 (ix), l
   4827 DD 36 EE 00   [19] 1375 	ld	-18 (ix), #0x00
   482B F5            [11] 1376 	push	af
   482C 33            [ 6] 1377 	inc	sp
   482D D5            [11] 1378 	push	de
   482E 33            [ 6] 1379 	inc	sp
   482F C5            [11] 1380 	push	bc
   4830 DD 6E ED      [19] 1381 	ld	l,-19 (ix)
   4833 DD 66 EE      [19] 1382 	ld	h,-18 (ix)
   ...
   4844 FD 21 98 67   [14] 1395 	ld	iy, #_g_checkpointactive
   4848 FD 7E 00      [19] 1396 	ld	a, 0 (iy)
   484B B7            [ 4] 1397 	or	a, a
   484C 20 1E         [12] 1398 	jr	NZ,00151$
   484E 3A 06 67      [13] 1399 	ld	a, (#_g_player + 0)
   ...
   4859 21 96 67      [10] 1405 	ld	hl,#_g_checkpointx + 0
   485C 36 34         [10] 1406 	ld	(hl), #0x34
                           1407 ;src/game.c:247: g_checkpointy = (u8)(tilemap_ground_y() - g_player.h);
   485E CD AD 53      [17] 1408 	call	_tilemap_ground_y
   4861 4D            [ 4] 1409 	ld	c, l
   4862 21 0B 67      [10] 1410 	ld	hl, #(_g_player + 0x0005) + 0
   4865 46            [ 7] 1411 	ld	b, (hl)
   4866 21 97 67      [10] 1412 	ld	hl, #_g_checkpointy
   ...
   486C 3A A6 67      [13] 1418 	ld	a,(#_g_pickuptaken + 0)
   486F B7            [ 4] 1419 	or	a, a
   4870 C2 FF 48      [10] 1420 	jp	NZ, 00154$
   4873 CD AD 53      [17] 1421 	call	_tilemap_ground_y
   4876 DD 75 ED      [19] 1422 	ld	-19 (ix), l
   4879 DD 75 ED      [19] 1423 	ld	-19 (ix), l
   487C DD 36 EE 00   [19] 1424 	ld	-18 (ix), #0x00
   4880 DD 7E ED      [19] 1425 	ld	a, -19 (ix)
   4883 C6 F8         [ 7] 1426 	add	a, #0xf8
   4885 DD 77 ED      [19] 1427 	ld	-19 (ix), a
   4888 DD 7E EE      [19] 1428 	ld	a, -18 (ix)
   488B CE FF         [ 7] 1429 	adc	a, #0xff
   488D DD 77 EE      [19] 1430 	ld	-18 (ix), a
   4890 3A 0B 67      [13] 1431 	ld	a,(#(_g_player + 0x0005) + 0)
   4893 DD 77 EF      [19] 1432 	ld	-17 (ix), a
   4896 3A 0A 67      [13] 1433 	ld	a,(#(_g_player + 0x0004) + 0)
   4899 DD 77 FD      [19] 1434 	ld	-3 (ix), a
   489C 3A 07 67      [13] 1435 	ld	a,(#(_g_player + 0x0001) + 0)
   489F DD 77 FE      [19] 1436 	ld	-2 (ix), a
   48A2 DD 77 FE      [19] 1437 	ld	-2 (ix), a
   48A5 DD 36 FF 00   [19] 1438 	ld	-1 (ix), #0x00
   48A9 3A 06 67      [13] 1439 	ld	a,(#_g_player + 0)
   48AC DD 77 F7      [19] 1440 	ld	-9 (ix), a
   48AF DD 77 F7      [19] 1441 	ld	-9 (ix), a
   48B2 DD 36 F8 00   [19] 1442 	ld	-8 (ix), #0x00
   48B6 21 04 04      [10] 1443 	ld	hl, #0x0404
   48B9 E5            [11] 1444 	push	hl
   48BA DD 6E ED      [19] 1445 	ld	l,-19 (ix)
   48BD DD 66 EE      [19] 1446 	ld	h,-18 (ix)
   48C0 E5            [11] 1447 	push	hl
   48C1 21 24 00      [10] 1448 	ld	hl, #0x0024
   48C4 E5            [11] 1449 	push	hl
   48C5 DD 66 EF      [19] 1450 	ld	h, -17 (ix)
   48C8 DD 6E FD      [19] 1451 	ld	l, -3 (ix)
   48CB E5            [11] 1452 	push	hl
   48CC DD 6E FE      [19] 1453 	ld	l,-2 (ix)
   48CF DD 66 FF      [19] 1454 	ld	h,-1 (ix)
   48D2 E5            [11] 1455 	push	hl
   48D3 DD 6E F7      [19] 1456 	ld	l,-9 (ix)
   48D6 DD 66 F8      [19] 1457 	ld	h,-8 (ix)
   ...
   4952 FD 21 94 67   [14] 1539 	ld	iy, #_g_framecounter
   ...
   49B5 CD FF 65      [17] 1606 	call	_cpct_memset
                           1607 ;src/game.c:287: tilemap_render();
   49B8 CD 0C 53      [17] 1608 	call	_tilemap_render
   ...
   49C5 11 4C 67      [10] 1620 	ld	de, #_g_projectiles
   49C8 19            [11] 1621 	add	hl, de
   49C9 C5            [11] 1622 	push	bc
   49CA E5            [11] 1623 	push	hl
   49CB CD AB 63      [17] 1624 	call	_projectilerender
   ...
   49E0 11 10 67      [10] 1643 	ld	de, #_g_enemies
   49E3 19            [11] 1644 	add	hl, de
   49E4 C5            [11] 1645 	push	bc
   49E5 E5            [11] 1646 	push	hl
   49E6 CD 14 5E      [17] 1647 	call	_enemyrender
   ...
   49F1 3A A3 67      [13] 1656 	ld	a,(#_g_bossactive + 0)
   49F4 B7            [ 4] 1657 	or	a, a
   49F5 28 58         [12] 1658 	jr	Z,00104$
                           1659 ;src/game.c:298: enemyrender(&g_boss);
   49F7 21 99 67      [10] 1660 	ld	hl, #_g_boss
   49FA E5            [11] 1661 	push	hl
   49FB CD 14 5E      [17] 1662 	call	_enemyrender
   ...
   4A02 CD E3 65      [17] 1666 	call	_cpct_px2byteM0
   ...
   4A0F CD D6 66      [17] 1673 	call	_cpct_getScreenPtr
   ...
   4A1C CD 1D 66      [17] 1682 	call	_cpct_drawSolidBox
   ...
   4A22 3A A0 67      [13] 1687 	ld	a, (#_g_boss + 7)
   ...
   4A2E CD E3 65      [17] 1695 	call	_cpct_px2byteM0
   ...
   4A3D CD D6 66      [17] 1704 	call	_cpct_getScreenPtr
   ...
   4A59 CD E3 65      [17] 1725 	call	_cpct_px2byteM0
   4A5C 55            [ 4] 1726 	ld	d, l
   4A5D D5            [11] 1727 	push	de
   4A5E CD AD 53      [17] 1728 	call	_tilemap_ground_y
   ...
   4A71 CD D6 66      [17] 1741 	call	_cpct_getScreenPtr
   ...
   4A99 CD E3 65      [17] 1769 	call	_cpct_px2byteM0
   ...
   4AA6 CD D6 66      [17] 1776 	call	_cpct_getScreenPtr
   ...
   4AB3 CD 1D 66      [17] 1785 	call	_cpct_drawSolidBox
   ...
   4ABC CD E3 65      [17] 1791 	call	_cpct_px2byteM0
   ...
   4AC9 CD D6 66      [17] 1798 	call	_cpct_getScreenPtr
   ...
   4AD6 CD 1D 66      [17] 1807 	call	_cpct_drawSolidBox
   ...
   4ADD 3A 93 67      [13] 1814 	ld	a,(#_g_gameover + 0)
   ...
   4AE7 CD E3 65      [17] 1820 	call	_cpct_px2byteM0
   ...
   4AF4 CD D6 66      [17] 1827 	call	_cpct_getScreenPtr
   ...
   4B01 CD 1D 66      [17] 1836 	call	_cpct_drawSolidBox
   ...
   4B0A CD E3 65      [17] 1842 	call	_cpct_px2byteM0
   ...
   4B17 CD D6 66      [17] 1849 	call	_cpct_getScreenPtr
   ...
   4B24 CD 1D 66      [17] 1858 	call	_cpct_drawSolidBox
   ...
   4B2B 3A 98 67      [13] 1865 	ld	a,(#_g_checkpointactive + 0)
   ...
   4B57 CD 1D 66      [17] 1893 	call	_cpct_drawSolidBox
