...
;src/systems/collision.c:42: platformmaxy = gplatformy - (i16)h;
	...
	sbc	a, b
	ld	b, a
;src/systems/collision.c:45: if (y > platformmaxy && y < gplatformy) {
	ld	a, c
	sub	a, 6 (ix)
	ld	a, b
	sbc	a, 7 (ix)
...
00128$:
	jp	P, 00105$
;src/systems/collision.c:46: return platformmaxy;
	ld	l, c
	ld	h, b
	jr	00108$
00105$:
;src/systems/collision.c:50: if (y > maxy) {
	ld	a, e
	sub	a, 6 (ix)
	ld	a, d
	sbc	a, 7 (ix)
...
00129$:
	jp	P, 00107$
;src/systems/collision.c:51: return maxy;
	ex	de,hl
	jr	00108$
00107$:
;src/systems/collision.c:53: return y;
	ld	l,6 (ix)
	ld	h,7 (ix)
00108$:
	pop	ix
	ret
;src/systems/collision.c:56: u8 collision_is_on_trap(i16 x, i16 y, u8 w, u8 h) {
;	---------------------------------
; Function collision_is_on_trap
; ---------------------------------
_collision_is_on_trap::
;src/systems/collision.c:57: return tilemap_is_trap(x, y, w, h);
	ld	hl, #7+0
	add	hl, sp
	ld	a, (hl)
	push	af
	...
	pop	af
	ret
;src/systems/collision.c:60: u8 collision_is_on_ladder(i16 x, i16 y, u8 w, u8 h) {
;	---------------------------------
; Function collision_is_on_ladder
; ---------------------------------
_collision_is_on_ladder::
;src/systems/collision.c:61: return tilemap_is_ladder(x, y, w, h);
	ld	hl, #7+0
	add	hl, sp
	ld	a, (hl)
	push	af
