                             ...
                             51 ; ---------------------------------
   4B5E                      52 _cpc_entry_wrapper::
                             53 ;src/main.c:23: __endasm;
                             54 	.globl	cpc_run_address
                             55 	.globl	s__INITIALIZER
                             56 	.globl	s__INITIALIZED
                             57 	.globl	l__INITIALIZER
   4B5E                      58 	    cpc_run_address::
   4B5E F3            [ 4]   59 	di
   4B5F 31 F0 BF      [10]   60 	ld	sp, #0xBFF0
   4B62 01 07 00      [10]   61 	ld	bc, #l__INITIALIZER
   4B65 78            [ 4]   62 	ld	a, b
   4B66 B1            [ 4]   63 	or	c
   4B67 28 08         [12]   64 	jr	z, 00001$
   4B69 11 5B 5F      [10]   65 	ld	de, #s__INITIALIZED
   4B6C 21 62 5F      [10]   66 	ld	hl, #s__INITIALIZER
   4B6F ED B0         [21]   67 	ldir
   4B71                      68 	00001$:
   4B71 CD 75 4B      [17]   69 	call	_main
   4B74 C9            [10]   70 	ret
   ...
   4B75 F3            [ 4]   77 	di
   4B76 31 F0 BF      [10]   78 	ld	sp, #0xBFF0
                             79 ;src/main.c:33: game_init();
   4B79 CD B3 42      [17]   80 	call	_game_init
                             81 ;src/main.c:34: while (1) {
   4B7C                      82 00102$:
                             83 ;src/main.c:35: game_update();
   4B7C CD 83 43      [17]   84 	call	_game_update
                             85 ;src/main.c:36: game_render();
   4B7F CD AB 49      [17]   86 	call	_game_render
                             87 ;src/main.c:37: cpct_waitVSYNC();
   4B82 CD 75 5D      [17]   88 	call	_cpct_waitVSYNC
   4B85 18 F5         [12]   89 	jr	00102$
                             90 	.area _CODE
