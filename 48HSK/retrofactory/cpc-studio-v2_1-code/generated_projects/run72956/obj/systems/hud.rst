                             ...
                             21 ;--------------------------------------------------------
                             22 	.area _DATA
   5F19                      23 _currenthealth:
   5F19                      24 	.ds 1
   5F1A                      25 _currentscore:
   5F1A                      26 	.ds 2
   5F1C                      27 _currenttime:
   5F1C                      28 	.ds 1
   5F1D                      29 _currentlives:
   5F1D                      30 	.ds 1
   5F1E                      31 _currentweapon:
   5F1E                      32 	.ds 1
                             33 ;--------------------------------------------------------
                             34 ; ram data
                             35 ;--------------------------------------------------------
   ...
   4E03 CD A0 5B      [17]  302 	call	__divuint
   ...
   4E14 CD 2B 5D      [17]  314 	call	__moduint
   ...
   4E3C CD 49 5E      [17]  340 	call	_cpct_getScreenPtr
   ...
   4E58 CD 7A 5C      [17]  361 	call	_cpct_drawSprite
   ...
   4E69 CD A0 5B      [17]  373 	call	__divuint
   ...
   4EC8                     449 00103$:
   4EC8 21 19 5F      [10]  450 	ld	hl, #_currenthealth
   ...
   4EE0 CD 49 5E      [17]  468 	call	_cpct_getScreenPtr
   ...
   4EEC CD 7A 5C      [17]  474 	call	_cpct_drawSprite
   ...
   4EF3 2A 1A 5F      [16]  481 	ld	hl, (_currentscore)
   ...
   4F05 21 1C 5F      [10]  494 	ld	hl,#_currenttime + 0
   ...
   4F21 CD 49 5E      [17]  512 	call	_cpct_getScreenPtr
   ...
   4F2D CD 7A 5C      [17]  519 	call	_cpct_drawSprite
   ...
   4F38 CD 49 5E      [17]  525 	call	_cpct_getScreenPtr
   ...
   4F40 3A 1D 5F      [13]  531 	ld	a, (_currentlives)
   4F43 F5            [11]  532 	push	af
   4F44 33            [ 6]  533 	inc	sp
   4F45 CD 1F 5D      [17]  534 	call	__moduchar
   ...
   4F57 CD 7A 5C      [17]  546 	call	_cpct_drawSprite
   ...
   4F62 CD 49 5E      [17]  552 	call	_cpct_getScreenPtr
   ...
   4F6A 3A 1E 5F      [13]  558 	ld	a, (_currentweapon)
   4F6D F5            [11]  559 	push	af
   4F6E 33            [ 6]  560 	inc	sp
   4F6F CD 1F 5D      [17]  561 	call	__moduchar
   ...
   4F81 CD 7A 5C      [17]  573 	call	_cpct_drawSprite
   4F84 C9            [10]  574 	ret
                            575 	.area _CODE
