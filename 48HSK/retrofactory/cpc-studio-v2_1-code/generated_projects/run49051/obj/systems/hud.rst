                             ...
                             21 ;--------------------------------------------------------
                             22 	.area _DATA
   648C                      23 _currenthealth:
   648C                      24 	.ds 1
   648D                      25 _currentscore:
   648D                      26 	.ds 2
   648F                      27 _currenttime:
   648F                      28 	.ds 1
   6490                      29 _currentlives:
   6490                      30 	.ds 1
   6491                      31 _currentweapon:
   6491                      32 	.ds 1
                             33 ;--------------------------------------------------------
                             34 ; ram data
                             35 ;--------------------------------------------------------
   ...
   4E65 33            [ 6]   70 	inc	sp
   4E66 CD 91 62      [17]   71 	call	__moduchar
   ...
   5050 CD 12 61      [17]  539 	call	__divuint
   ...
   5061 CD 9D 62      [17]  551 	call	__moduint
   ...
   5086 CD BB 63      [17]  575 	call	_cpct_getScreenPtr
   ...
   50A2 CD EC 61      [17]  596 	call	_cpct_drawSprite
   ...
   50B3 CD 12 61      [17]  608 	call	__divuint
   ...
   510C 32 91 64      [13]  675 	ld	(#_currentweapon + 0),a
   510F C9            [10]  676 	ret
   ...
   5112                     684 00103$:
   5112 21 8C 64      [10]  685 	ld	hl, #_currenthealth
   ...
   512A CD BB 63      [17]  703 	call	_cpct_getScreenPtr
   512D 11 04 08      [10]  704 	ld	de, #0x0804
   5130 D5            [11]  705 	push	de
   5131 E5            [11]  706 	push	hl
   5132 21 81 55      [10]  707 	ld	hl, #_hudhealthbar_data
   5135 E5            [11]  708 	push	hl
   5136 CD EC 61      [17]  709 	call	_cpct_drawSprite
   ...
   513D 2A 8D 64      [16]  716 	ld	hl, (_currentscore)
   ...
   514F 21 8F 64      [10]  729 	ld	hl,#_currenttime + 0
   ...
   516B CD BB 63      [17]  747 	call	_cpct_getScreenPtr
   ...
   5177 CD EC 61      [17]  754 	call	_cpct_drawSprite
   ...
   5182 CD BB 63      [17]  760 	call	_cpct_getScreenPtr
   ...
   518A 3A 90 64      [13]  766 	ld	a, (_currentlives)
   518D F5            [11]  767 	push	af
   518E 33            [ 6]  768 	inc	sp
   518F CD 91 62      [17]  769 	call	__moduchar
   ...
   51A1 CD EC 61      [17]  781 	call	_cpct_drawSprite
   ...
   51AC CD BB 63      [17]  787 	call	_cpct_getScreenPtr
   ...
   51B4 3A 91 64      [13]  793 	ld	a, (_currentweapon)
   51B7 F5            [11]  794 	push	af
   51B8 33            [ 6]  795 	inc	sp
   51B9 CD 91 62      [17]  796 	call	__moduchar
   ...
   51CB CD EC 61      [17]  808 	call	_cpct_drawSprite
   51CE C9            [10]  809 	ret
                            810 	.area _CODE
