   ...
   647C                      29 _ginputleft:
   647C                      30 	.ds 1
   647D                      31 _ginputright:
   647D                      32 	.ds 1
   647E                      33 _ginputup:
   647E                      34 	.ds 1
   647F                      35 _ginputdown:
   647F                      36 	.ds 1
   6480                      37 _ginputshoot:
   6480                      38 	.ds 1
   6481                      39 _gprevjump:
   6481                      40 	.ds 1
   6482                      41 _gprevshoot:
   ...
   51CF 3A 7E 64      [13]   73 	ld	a,(#_ginputup + 0)
   51D2 32 81 64      [13]   74 	ld	(#_gprevjump + 0),a
                             75 ;src/systems/input.c:13: gprevshoot = ginputshoot;
   51D5 3A 80 64      [13]   76 	ld	a,(#_ginputshoot + 0)
   51D8 32 82 64      [13]   77 	ld	(#_gprevshoot + 0),a
                             78 ;src/systems/input.c:14: cpct_scanKeyboard_f();
   51DB CD 49 61      [17]   79 	call	_cpct_scanKeyboard_f
                             80 ;src/systems/input.c:15: ginputleft = cpct_isKeyPressed(Key_CursorLeft);
   51DE 21 01 01      [10]   81 	ld	hl, #0x0101
   51E1 CD 3D 61      [17]   82 	call	_cpct_isKeyPressed
   51E4 FD 21 7C 64   [14]   83 	ld	iy, #_ginputleft
   ...
   51EE CD 3D 61      [17]   87 	call	_cpct_isKeyPressed
   51F1 FD 21 7D 64   [14]   88 	ld	iy, #_ginputright
   ...
   51FB CD 3D 61      [17]   92 	call	_cpct_isKeyPressed
   51FE FD 21 7E 64   [14]   93 	ld	iy, #_ginputup
   ...
   5208 CD 3D 61      [17]   97 	call	_cpct_isKeyPressed
   520B FD 21 7F 64   [14]   98 	ld	iy, #_ginputdown
   ...
   5215 CD 3D 61      [17]  102 	call	_cpct_isKeyPressed
   5218 FD 21 80 64   [14]  103 	ld	iy, #_ginputshoot
   ...
   5220 FD 21 7C 64   [14]  112 	ld	iy, #_ginputleft
   ...
   5228 FD 21 7D 64   [14]  121 	ld	iy, #_ginputright
   ...
   5230 FD 21 7E 64   [14]  130 	ld	iy, #_ginputup
   ...
   5238 FD 21 7F 64   [14]  139 	ld	iy, #_ginputdown
   ...
   5240 FD 21 7E 64   [14]  148 	ld	iy, #_ginputup
   ...
   5248 3A 7E 64      [13]  157 	ld	a,(#_ginputup + 0)
   524B B7            [ 4]  158 	or	a, a
   524C 28 06         [12]  159 	jr	Z,00103$
   524E 3A 81 64      [13]  160 	ld	a,(#_gprevjump + 0)
   ...
   525A FD 21 80 64   [14]  175 	ld	iy, #_ginputshoot
   ...
   5262 3A 80 64      [13]  184 	ld	a,(#_ginputshoot + 0)
   5265 B7            [ 4]  185 	or	a, a
   5266 28 06         [12]  186 	jr	Z,00103$
   5268 3A 82 64      [13]  187 	ld	a,(#_gprevshoot + 0)
