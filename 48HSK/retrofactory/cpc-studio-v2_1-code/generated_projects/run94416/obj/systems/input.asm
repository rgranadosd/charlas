...
;src/systems/input.c:15: ginputleft = (u8)(cpct_isKeyPressed(Key_CursorLeft) || cpct_isKeyPressed(Key_A));
	ld	hl, #0x0101
...
00105$:
	ld	hl,#_ginputleft + 0
	ld	(hl), c
;src/systems/input.c:16: ginputright = (u8)(cpct_isKeyPressed(Key_CursorRight) || cpct_isKeyPressed(Key_D));
	ld	hl, #0x0200
	call	_cpct_isKeyPressed
	ld	a, l
	or	a, a
...
00108$:
	...
	ld	(hl), c
;src/systems/input.c:17: ginputup = (u8)(cpct_isKeyPressed(Key_CursorUp) || cpct_isKeyPressed(Key_W) || cpct_isKeyPressed(Key_Z));
	ld	hl, #0x0100
	call	_cpct_isKeyPressed
	ld	a, l
	or	a, a
...
00111$:
	ld	hl,#_ginputup + 0
	ld	(hl), c
;src/systems/input.c:18: ginputdown = (u8)(cpct_isKeyPressed(Key_CursorDown) || cpct_isKeyPressed(Key_S) || cpct_isKeyPressed(Key_X));
	ld	hl, #0x0400
	call	_cpct_isKeyPressed
	ld	a, l
	or	a, a
...
00117$:
	ld	hl,#_ginputdown + 0
	ld	(hl), c
;src/systems/input.c:19: ginputshoot = (u8)(cpct_isKeyPressed(Key_Space) || cpct_isKeyPressed(Key_X) || cpct_isKeyPressed(Key_CursorDown));
	ld	hl, #0x8005
	call	_cpct_isKeyPressed
	ld	a, l
	or	a, a
