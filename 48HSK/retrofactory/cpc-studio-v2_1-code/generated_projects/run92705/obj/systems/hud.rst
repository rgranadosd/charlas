                             ...
                             21 ;--------------------------------------------------------
                             22 	.area _DATA
   49D2                      23 _currenthealth:
   49D2                      24 	.ds 1
   49D3                      25 _currentscore:
   49D3                      26 	.ds 2
   49D5                      27 _currenttime:
   49D5                      28 	.ds 1
   49D6                      29 _currentlives:
   49D6                      30 	.ds 1
                             31 ;--------------------------------------------------------
                             32 ; ram data
                             33 ;--------------------------------------------------------
   ...
   49DC                      36 	.ds 20
                             ...
                             55 ;--------------------------------------------------------
                             56 	.area _CODE
                             57 ;src/systems/hud.c:17: static void hud_draw_digits(u16 value, u8 digits, u8 startx, u8 y) {
                             58 ;	---------------------------------
   ...
   40D9 4D            [ 4]   81 	ld	c, l
   40DA 44            [ 4]   82 	ld	b, h
                             83 ;src/systems/hud.c:24: for (i = 1; i < digits; ++i) {
   40DB 1C            [ 4]   84 	inc	e
   40DC 18 EF         [12]   85 	jr	00106$
   40DE                      86 00101$:
                             87 ;src/systems/hud.c:28: for (i = 0; i < digits; ++i) {
   ...
   40E8 30 7B         [12]   92 	jr	NC,00111$
                             93 ;src/systems/hud.c:29: digit = (u8)(value / divisor);
   ...
   4104 CD AA 48      [17]  111 	call	__moduint
   ...
   410E DD 74 05      [19]  117 	ld	5 (ix), h
                            118 ;src/systems/hud.c:32: pvmem = cpct_getScreenPtr(CPCT_VMEM_START, startx + (i * 8), y);
   ...
   4147 CD F9 47      [17]  156 	call	_cpct_drawSprite
   414A C1            [10]  157 	pop	bc
                            158 ;src/systems/hud.c:35: if (divisor > 1) {
   ...
   4227 00                  374 	.db 0x00
   4228 00                  375 	.db 0x00
                            376 ;src/systems/hud.c:41: void hudinit(void) {
                            377 ;	---------------------------------
                            378 ; Function hudinit
                            379 ; ---------------------------------
   4229                     380 _hudinit::
                            381 ;src/systems/hud.c:42: currenthealth = 3;
   4229 21 D2 49      [10]  382 	ld	hl,#_currenthealth + 0
   422C 36 03         [10]  383 	ld	(hl), #0x03
                            384 ;src/systems/hud.c:43: currentscore  = 0;
   422E 21 00 00      [10]  385 	ld	hl, #0x0000
   4231 22 D3 49      [16]  386 	ld	(_currentscore), hl
                            387 ;src/systems/hud.c:44: currenttime   = 90;
   4234 21 D5 49      [10]  388 	ld	hl,#_currenttime + 0
   4237 36 5A         [10]  389 	ld	(hl), #0x5a
                            390 ;src/systems/hud.c:45: currentlives  = 3;
   4239 21 D6 49      [10]  391 	ld	hl,#_currentlives + 0
   423C 36 03         [10]  392 	ld	(hl), #0x03
   423E C9            [10]  393 	ret
                            394 ;src/systems/hud.c:48: void hudupdate(u8 health, u16 score, u8 time, u8 lives) {
                            395 ;	---------------------------------
                            396 ; Function hudupdate
                            397 ; ---------------------------------
   423F                     398 _hudupdate::
                            399 ;src/systems/hud.c:49: currenthealth = health;
   423F 21 02 00      [10]  400 	ld	hl, #2+0
   4242 39            [11]  401 	add	hl, sp
   4243 7E            [ 7]  402 	ld	a, (hl)
   4244 32 D2 49      [13]  403 	ld	(#_currenthealth + 0),a
                            404 ;src/systems/hud.c:50: currentscore  = score;
   4247 21 03 00      [10]  405 	ld	hl, #3+0
   424A 39            [11]  406 	add	hl, sp
   424B 7E            [ 7]  407 	ld	a, (hl)
   424C 32 D3 49      [13]  408 	ld	(#_currentscore + 0),a
   424F 21 04 00      [10]  409 	ld	hl, #3+1
   4252 39            [11]  410 	add	hl, sp
   4253 7E            [ 7]  411 	ld	a, (hl)
   4254 32 D4 49      [13]  412 	ld	(#_currentscore + 1),a
                            413 ;src/systems/hud.c:51: currenttime   = time;
   4257 21 05 00      [10]  414 	ld	hl, #5+0
   425A 39            [11]  415 	add	hl, sp
   425B 7E            [ 7]  416 	ld	a, (hl)
   425C 32 D5 49      [13]  417 	ld	(#_currenttime + 0),a
                            418 ;src/systems/hud.c:52: currentlives  = lives;
   425F 21 06 00      [10]  419 	ld	hl, #6+0
   4262 39            [11]  420 	add	hl, sp
   4263 7E            [ 7]  421 	ld	a, (hl)
   4264 32 D6 49      [13]  422 	ld	(#_currentlives + 0),a
   4267 C9            [10]  423 	ret
                            424 ;src/systems/hud.c:55: void hudrender(void) {
                            425 ;	---------------------------------
                            426 ; Function hudrender
                            427 ; ---------------------------------
   4268                     428 _hudrender::
                            429 ;src/systems/hud.c:61: for (i = 0; i < currenthealth; ++i) {
   4268 0E 00         [ 7]  430 	ld	c, #0x00
   426A                     431 00103$:
   426A 21 D2 49      [10]  432 	ld	hl, #_currenthealth
                            433 ;src/systems/hud.c:62: pvmem = cpct_getScreenPtr(CPCT_VMEM_START, 2 + (i * 8), 2);
   ...
   4284 CD AC 49      [17]  452 	call	_cpct_getScreenPtr
   ...
   4290 CD F9 47      [17]  458 	call	_cpct_drawSprite
   4293 C1            [10]  459 	pop	bc
                            460 ;src/systems/hud.c:61: for (i = 0; i < currenthealth; ++i) {
   4294 0C            [ 4]  461 	inc	c
   4295 18 D3         [12]  462 	jr	00103$
   4297                     463 00101$:
                            464 ;src/systems/hud.c:66: scoretemp = currentscore;
   4297 2A D3 49      [16]  465 	ld	hl, (_currentscore)
                            466 ;src/systems/hud.c:67: hud_draw_digits(scoretemp, 5, 88, 2);
   ...
   42A8 33            [ 6]  476 	inc	sp
                            477 ;src/systems/hud.c:69: timetemp = currenttime;
   42A9 21 D5 49      [10]  478 	ld	hl,#_currenttime + 0
   42AC 4E            [ 7]  479 	ld	c, (hl)
                            480 ;src/systems/hud.c:70: hud_draw_digits((u16)timetemp, 3, 56, 2);
   ...
   42BB F1            [10]  489 	pop	af
                            490 ;src/systems/hud.c:72: pvmem = cpct_getScreenPtr(CPCT_VMEM_START, 2, 180);
   ...
   42C5 CD AC 49      [17]  496 	call	_cpct_getScreenPtr
                            497 ;src/systems/hud.c:73: cpct_drawSprite((u8*)hudlives, pvmem, 8, 8);
   ...
   42D1 CD F9 47      [17]  503 	call	_cpct_drawSprite
                            504 ;src/systems/hud.c:75: pvmem = cpct_getScreenPtr(CPCT_VMEM_START, 12, 180);
   42D4 21 0C B4      [10]  505 	ld	hl, #0xb40c
   42D7 E5            [11]  506 	push	hl
   42D8 21 00 C0      [10]  507 	ld	hl, #0xc000
   42DB E5            [11]  508 	push	hl
   42DC CD AC 49      [17]  509 	call	_cpct_getScreenPtr
                            510 ;src/systems/hud.c:76: cpct_drawSprite((u8*)hudnumbers[currentlives % 10], pvmem, 8, 8);
   42DF E5            [11]  511 	push	hl
   42E0 3E 0A         [ 7]  512 	ld	a, #0x0a
   42E2 F5            [11]  513 	push	af
   42E3 33            [ 6]  514 	inc	sp
   42E4 3A D6 49      [13]  515 	ld	a, (_currentlives)
   42E7 F5            [11]  516 	push	af
   42E8 33            [ 6]  517 	inc	sp
   42E9 CD 9E 48      [17]  518 	call	__moduchar
   42EC F1            [10]  519 	pop	af
   42ED C1            [10]  520 	pop	bc
   42EE 26 00         [ 7]  521 	ld	h, #0x00
   42F0 29            [11]  522 	add	hl, hl
   42F1 11 DC 49      [10]  523 	ld	de, #_hudnumbers
   ...
   42FE CD F9 47      [17]  532 	call	_cpct_drawSprite
   4301 C9            [10]  533 	ret
                            534 	.area _CODE
                            535 	.area _INITIALIZER
   49F3                     536 __xinit__hudnumbers:
   49F3 69 41               537 	.dw __hud_dummy_sprite
   49F5 69 41               538 	.dw __hud_dummy_sprite
   49F7 69 41               539 	.dw __hud_dummy_sprite
   49F9 69 41               540 	.dw __hud_dummy_sprite
   49FB 69 41               541 	.dw __hud_dummy_sprite
   49FD 69 41               542 	.dw __hud_dummy_sprite
   49FF 69 41               543 	.dw __hud_dummy_sprite
   4A01 69 41               544 	.dw __hud_dummy_sprite
   4A03 69 41               545 	.dw __hud_dummy_sprite
   4A05 69 41               546 	.dw __hud_dummy_sprite
                            547 	.area _CABS (ABS)
