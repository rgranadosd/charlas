   ...
   6301                      29 _ginputleft:
   6301                      30 	.ds 1
   6302                      31 _ginputright:
   6302                      32 	.ds 1
   6303                      33 _ginputup:
   6303                      34 	.ds 1
   6304                      35 _ginputdown:
   6304                      36 	.ds 1
   6305                      37 _ginputshoot:
   6305                      38 	.ds 1
   6306                      39 _gprevjump:
   6306                      40 	.ds 1
   6307                      41 _gprevshoot:
   ...
   5095 3A 03 63      [13]   73 	ld	a,(#_ginputup + 0)
   5098 32 06 63      [13]   74 	ld	(#_gprevjump + 0),a
                             75 ;src/systems/input.c:13: gprevshoot = ginputshoot;
   509B 3A 05 63      [13]   76 	ld	a,(#_ginputshoot + 0)
   509E 32 07 63      [13]   77 	ld	(#_gprevshoot + 0),a
                             78 ;src/systems/input.c:14: cpct_scanKeyboard_f();
   50A1 CD CE 5F      [17]   79 	call	_cpct_scanKeyboard_f
                             80 ;src/systems/input.c:15: ginputleft = cpct_isKeyPressed(Key_CursorLeft);
   50A4 21 01 01      [10]   81 	ld	hl, #0x0101
   50A7 CD C2 5F      [17]   82 	call	_cpct_isKeyPressed
   50AA FD 21 01 63   [14]   83 	ld	iy, #_ginputleft
   ...
   50B4 CD C2 5F      [17]   87 	call	_cpct_isKeyPressed
   50B7 FD 21 02 63   [14]   88 	ld	iy, #_ginputright
   ...
   50C1 CD C2 5F      [17]   92 	call	_cpct_isKeyPressed
   50C4 FD 21 03 63   [14]   93 	ld	iy, #_ginputup
   ...
   50CE CD C2 5F      [17]   97 	call	_cpct_isKeyPressed
   50D1 FD 21 04 63   [14]   98 	ld	iy, #_ginputdown
   ...
   50DB CD C2 5F      [17]  102 	call	_cpct_isKeyPressed
   50DE FD 21 05 63   [14]  103 	ld	iy, #_ginputshoot
   ...
   50E6 FD 21 01 63   [14]  112 	ld	iy, #_ginputleft
   ...
   50EE FD 21 02 63   [14]  121 	ld	iy, #_ginputright
   ...
   50F6 FD 21 03 63   [14]  130 	ld	iy, #_ginputup
   ...
   50FE FD 21 04 63   [14]  139 	ld	iy, #_ginputdown
   ...
   5106 FD 21 03 63   [14]  148 	ld	iy, #_ginputup
   ...
   510E 3A 03 63      [13]  157 	ld	a,(#_ginputup + 0)
   5111 B7            [ 4]  158 	or	a, a
   5112 28 06         [12]  159 	jr	Z,00103$
   5114 3A 06 63      [13]  160 	ld	a,(#_gprevjump + 0)
   ...
   5120 FD 21 05 63   [14]  175 	ld	iy, #_ginputshoot
   ...
   5128 3A 05 63      [13]  184 	ld	a,(#_ginputshoot + 0)
   512B B7            [ 4]  185 	or	a, a
   512C 28 06         [12]  186 	jr	Z,00103$
   512E 3A 07 63      [13]  187 	ld	a,(#_gprevshoot + 0)
