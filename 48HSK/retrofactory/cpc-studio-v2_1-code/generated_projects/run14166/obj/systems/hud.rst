                             ...
                             21 ;--------------------------------------------------------
                             22 	.area _DATA
   62FB                      23 _currenthealth:
   62FB                      24 	.ds 1
   62FC                      25 _currentscore:
   62FC                      26 	.ds 2
   62FE                      27 _currenttime:
   62FE                      28 	.ds 1
   62FF                      29 _currentlives:
   62FF                      30 	.ds 1
   6300                      31 _currentweapon:
   6300                      32 	.ds 1
                             33 ;--------------------------------------------------------
                             34 ; ram data
                             35 ;--------------------------------------------------------
   ...
   4D2B 33            [ 6]   70 	inc	sp
   4D2C CD 00 61      [17]   71 	call	__moduchar
   ...
   4F16 CD 81 5F      [17]  539 	call	__divuint
   ...
   4F27 CD 0C 61      [17]  551 	call	__moduint
   ...
   4F4C CD 2A 62      [17]  575 	call	_cpct_getScreenPtr
   ...
   4F68 CD 5B 60      [17]  596 	call	_cpct_drawSprite
   ...
   4F79 CD 81 5F      [17]  608 	call	__divuint
   ...
   4FD2 32 00 63      [13]  675 	ld	(#_currentweapon + 0),a
   4FD5 C9            [10]  676 	ret
   ...
   4FD8                     684 00103$:
   4FD8 21 FB 62      [10]  685 	ld	hl, #_currenthealth
   ...
   4FF0 CD 2A 62      [17]  703 	call	_cpct_getScreenPtr
   4FF3 11 04 08      [10]  704 	ld	de, #0x0804
   4FF6 D5            [11]  705 	push	de
   4FF7 E5            [11]  706 	push	hl
   4FF8 21 07 54      [10]  707 	ld	hl, #_hudhealthbar_data
   4FFB E5            [11]  708 	push	hl
   4FFC CD 5B 60      [17]  709 	call	_cpct_drawSprite
   ...
   5003 2A FC 62      [16]  716 	ld	hl, (_currentscore)
   ...
   5015 21 FE 62      [10]  729 	ld	hl,#_currenttime + 0
   ...
   5031 CD 2A 62      [17]  747 	call	_cpct_getScreenPtr
   ...
   503D CD 5B 60      [17]  754 	call	_cpct_drawSprite
   ...
   5048 CD 2A 62      [17]  760 	call	_cpct_getScreenPtr
   ...
   5050 3A FF 62      [13]  766 	ld	a, (_currentlives)
   5053 F5            [11]  767 	push	af
   5054 33            [ 6]  768 	inc	sp
   5055 CD 00 61      [17]  769 	call	__moduchar
   ...
   5067 CD 5B 60      [17]  781 	call	_cpct_drawSprite
   ...
   5072 CD 2A 62      [17]  787 	call	_cpct_getScreenPtr
   ...
   507A 3A 00 63      [13]  793 	ld	a, (_currentweapon)
   507D F5            [11]  794 	push	af
   507E 33            [ 6]  795 	inc	sp
   507F CD 00 61      [17]  796 	call	__moduchar
   ...
   5091 CD 5B 60      [17]  808 	call	_cpct_drawSprite
   5094 C9            [10]  809 	ret
                            810 	.area _CODE
