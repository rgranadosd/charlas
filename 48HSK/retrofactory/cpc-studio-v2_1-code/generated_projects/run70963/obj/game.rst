   ...
   5F00                      62 _g_timeleft:
   5F00                      63 	.ds 1
   5F01                      64 _g_weapondisplay:
   5F01                      65 	.ds 1
   5F02                      66 _g_currentwave:
   5F02                      67 	.ds 1
   5F03                      68 _g_aliveenemies:
   5F03                      69 	.ds 1
   5F04                      70 _g_wavecooldown:
   5F04                      71 	.ds 1
   5F05                      72 _g_damagecooldown:
   5F05                      73 	.ds 1
   5F06                      74 _g_shootcooldown:
   5F06                      75 	.ds 1
   5F07                      76 _g_victory:
   5F07                      77 	.ds 1
   5F08                      78 _g_gameover:
   5F08                      79 	.ds 1
   5F09                      80 _g_framecounter:
   5F09                      81 	.ds 2
   5F0B                      82 _g_checkpointx:
   5F0B                      83 	.ds 1
   5F0C                      84 _g_checkpointy:
   5F0C                      85 	.ds 1
   5F0D                      86 _g_checkpointactive:
   5F0D                      87 	.ds 1
   5F0E                      88 _g_boss:
   5F0E                      89 	.ds 10
   5F18                      90 _g_bossactive:
   5F18                      91 	.ds 1
   5F19                      92 _g_bossphase:
   5F19                      93 	.ds 1
   5F1A                      94 _g_weaponlevel:
   5F1A                      95 	.ds 1
   5F1B                      96 _g_pickuptaken:
   5F1B                      97 	.ds 1
                             98 ;--------------------------------------------------------
                             99 ; ram data
                            100 ;--------------------------------------------------------
   ...
   4000 21 7C 5E      [10]  128 	ld	hl, #_g_player
   4003 3A 0B 5F      [13]  129 	ld	a,(#_g_checkpointx + 0)
   4006 77            [ 7]  130 	ld	(hl), a
                            131 ;src/game.c:43: g_player.y = g_checkpointy;
   4007 21 7D 5E      [10]  132 	ld	hl, #(_g_player + 0x0001)
   400A 3A 0C 5F      [13]  133 	ld	a,(#_g_checkpointy + 0)
   400D 77            [ 7]  134 	ld	(hl), a
                            135 ;src/game.c:44: g_player.vx = 0;
   400E 21 7E 5E      [10]  136 	ld	hl, #(_g_player + 0x0002)
   4011 36 00         [10]  137 	ld	(hl), #0x00
                            138 ;src/game.c:45: g_player.vy = 0;
   4013 21 7F 5E      [10]  139 	ld	hl, #(_g_player + 0x0003)
   ...
   40B1 01 85 5E      [10]  235 	ld	bc, #_g_enemies+0
   ...
   40C4 CD E1 51      [17]  252 	call	_enemyinit
   ...
   418C CD 26 52      [17]  385 	call	_enemyspawn
   ...
   419E 32 03 5F      [13]  396 	ld	(#_g_aliveenemies + 0),a
   ...
   41A6 21 0E 5F      [10]  406 	ld	hl, #_g_boss
   41A9 E5            [11]  407 	push	hl
   41AA CD E1 51      [17]  408 	call	_enemyinit
   ...
   421F 11 C1 5E      [10]  487 	ld	de, #_g_projectiles
   ...
   422B 3A 1A 5F      [13]  495 	ld	a,(#_g_weaponlevel + 0)
   ...
   423B                     502 00115$:
   423B 3A 7D 5E      [13]  503 	ld	a, (#_g_player + 1)
   423E C6 06         [ 7]  504 	add	a, #0x06
   4240 DD 77 FD      [19]  505 	ld	-3 (ix), a
   4243 21 7C 5E      [10]  506 	ld	hl, #_g_player + 0
   ...
   4254 11 C1 5E      [10]  518 	ld	de, #_g_projectiles
   ...
   4269 CD 05 5A      [17]  533 	call	_projectilefire
   ...
   4271 3A 1A 5F      [13]  538 	ld	a,(#_g_weaponlevel + 0)
   ...
   427D                     545 00117$:
   427D 21 06 5F      [10]  546 	ld	hl,#_g_shootcooldown + 0
   ...
   4291 FD 21 FD 5E   [14]  567 	ld	iy, #_g_lives
   ...
   42AD 21 05 5F      [10]  587 	ld	hl,#_g_damagecooldown + 0
   ...
   42B3 CD 83 5D      [17]  596 	call	_cpct_disableFirmware
                            597 ;src/game.c:133: cpct_setVideoMode(0);
   42B6 2E 00         [ 7]  598 	ld	l, #0x00
   42B8 CD 4B 5D      [17]  599 	call	_cpct_setVideoMode
   ...
   42C3 CD 5A 5C      [17]  605 	call	_cpct_setPalette
   ...
   42D0 CD 71 5C      [17]  614 	call	_cpct_setPALColour
   ...
   42DD CD 75 5D      [17]  623 	call	_cpct_memset
   ...
   42E6 21 7C 5E      [10]  629 	ld	hl, #_g_player
   42E9 E5            [11]  630 	push	hl
   42EA CD DC 56      [17]  631 	call	_playerinit
   ...
   42FB 11 C1 5E      [10]  646 	ld	de, #_g_projectiles
   42FE 19            [11]  647 	add	hl, de
   42FF C5            [11]  648 	push	bc
   4300 E5            [11]  649 	push	hl
   4301 CD C0 59      [17]  650 	call	_projectileinit
   ...
   43BB 21 7C 5E      [10]  756 	ld	hl, #_g_player
   43BE E5            [11]  757 	push	hl
   43BF CD 1C 57      [17]  758 	call	_playerupdate
   ...
   43C6 FD 21 06 5F   [14]  763 	ld	iy, #_g_shootcooldown
   ...
   43D3 FD 21 05 5F   [14]  770 	ld	iy, #_g_damagecooldown
   ...
   43EA 11 C1 5E      [10]  787 	ld	de, #_g_projectiles
   43ED 19            [11]  788 	add	hl, de
   43EE C5            [11]  789 	push	bc
   43EF E5            [11]  790 	push	hl
   43F0 CD BC 5A      [17]  791 	call	_projectileupdate
   ...
   4405 11 85 5E      [10]  810 	ld	de, #_g_enemies
   4408 19            [11]  811 	add	hl, de
   4409 C5            [11]  812 	push	bc
   440A E5            [11]  813 	push	hl
   440B CD FE 53      [17]  814 	call	_enemyupdate
   ...
   444E 21 0E 5F      [10]  851 	ld	hl, #_g_boss + 0
   ...
   4464 3A 19 5F      [13]  862 	ld	a,(#_g_bossphase + 0)
   ...
   4475                     874 00183$:
   4475 3A 19 5F      [13]  875 	ld	a,(#_g_bossphase + 0)
   ...
   4481                     882 00188$:
   4481                     883 00184$:
   4481 21 10 5F      [10]  884 	ld	hl, #(_g_boss + 0x0002)
   4484 71            [ 7]  885 	ld	(hl), c
                            886 ;src/game.c:196: enemyupdate(&g_boss);
   4485 21 0E 5F      [10]  887 	ld	hl, #_g_boss
   4488 E5            [11]  888 	push	hl
   4489 CD FE 53      [17]  889 	call	_enemyupdate
   ...
   4498 21 C1 5E      [10]  904 	ld	hl, #_g_projectiles
   ...
   44BD 3E 85         [ 7]  928 	ld	a, #<(_g_enemies)
   ...
   45B4 CD 9C 56      [17] 1051 	call	_enemydamage
   ...
   45D3 21 FE 5E      [10] 1069 	ld	hl, #_g_score
   ...
   45E1 FD 21 03 5F   [14] 1078 	ld	iy, #_g_aliveenemies
   ...
   4603 3A 18 5F      [13] 1098 	ld	a,(#_g_bossactive + 0)
   ...
   4615 21 13 5F      [10] 1107 	ld	hl, #(_g_boss + 0x0005) + 0
   4618 46            [ 7] 1108 	ld	b, (hl)
   4619 3A 12 5F      [13] 1109 	ld	a, (#(_g_boss + 0x0004) + 0)
   461C 21 0F 5F      [10] 1110 	ld	hl, #(_g_boss + 0x0001) + 0
   461F 6E            [ 7] 1111 	ld	l, (hl)
   4620 DD 75 E9      [19] 1112 	ld	-23 (ix), l
   4623 DD 36 EA 00   [19] 1113 	ld	-22 (ix), #0x00
   4627 21 0E 5F      [10] 1114 	ld	hl, #_g_boss + 0
   ...
   46C5 21 07 5F      [10] 1203 	ld	hl,#_g_victory + 0
   ...
   46D1 3A 05 5F      [13] 1213 	ld	a,(#_g_damagecooldown + 0)
   ...
   46E7 01 85 5E      [10] 1228 	ld	bc,#_g_enemies
   ...
   4737 3A 81 5E      [13] 1272 	ld	a,(#(_g_player + 0x0005) + 0)
   473A DD 77 ED      [19] 1273 	ld	-19 (ix), a
   473D 3A 80 5E      [13] 1274 	ld	a,(#(_g_player + 0x0004) + 0)
   4740 DD 77 EE      [19] 1275 	ld	-18 (ix), a
   4743 3A 7D 5E      [13] 1276 	ld	a, (#(_g_player + 0x0001) + 0)
   4746 DD 77 F0      [19] 1277 	ld	-16 (ix), a
   4749 DD 36 F1 00   [19] 1278 	ld	-15 (ix), #0x00
   474D 3A 7C 5E      [13] 1279 	ld	a, (#_g_player + 0)
   ...
   47BB 3A 81 5E      [13] 1334 	ld	a,(#(_g_player + 0x0005) + 0)
   47BE DD 77 ED      [19] 1335 	ld	-19 (ix), a
   47C1 3A 80 5E      [13] 1336 	ld	a,(#(_g_player + 0x0004) + 0)
   47C4 DD 77 EE      [19] 1337 	ld	-18 (ix), a
   47C7 3A 7D 5E      [13] 1338 	ld	a, (#(_g_player + 0x0001) + 0)
   47CA DD 77 F0      [19] 1339 	ld	-16 (ix), a
   47CD DD 36 F1 00   [19] 1340 	ld	-15 (ix), #0x00
   47D1 3A 7C 5E      [13] 1341 	ld	a, (#_g_player + 0)
   ...
   480B 3A 05 5F      [13] 1369 	ld	a,(#_g_damagecooldown + 0)
   480E B7            [ 4] 1370 	or	a, a
   480F 20 31         [12] 1371 	jr	NZ,00149$
   4811 3A 81 5E      [13] 1372 	ld	a, (#(_g_player + 0x0005) + 0)
   4814 21 80 5E      [10] 1373 	ld	hl, #(_g_player + 0x0004) + 0
   4817 56            [ 7] 1374 	ld	d, (hl)
   4818 21 7D 5E      [10] 1375 	ld	hl, #(_g_player + 0x0001) + 0
   481B 4E            [ 7] 1376 	ld	c, (hl)
   481C 06 00         [ 7] 1377 	ld	b, #0x00
   481E 21 7C 5E      [10] 1378 	ld	hl, #_g_player + 0
   ...
   4842 FD 21 0D 5F   [14] 1401 	ld	iy, #_g_checkpointactive
   4846 FD 7E 00      [19] 1402 	ld	a, 0 (iy)
   4849 B7            [ 4] 1403 	or	a, a
   484A 20 1E         [12] 1404 	jr	NZ,00151$
   484C 3A 7C 5E      [13] 1405 	ld	a, (#_g_player + 0)
   ...
   4857 21 0B 5F      [10] 1411 	ld	hl,#_g_checkpointx + 0
   ...
   4860 21 81 5E      [10] 1416 	ld	hl, #(_g_player + 0x0005) + 0
   4863 46            [ 7] 1417 	ld	b, (hl)
   4864 21 0C 5F      [10] 1418 	ld	hl, #_g_checkpointy
   ...
   486A 3A 1B 5F      [13] 1424 	ld	a,(#_g_pickuptaken + 0)
   ...
   488E 3A 81 5E      [13] 1437 	ld	a,(#(_g_player + 0x0005) + 0)
   4891 DD 77 EB      [19] 1438 	ld	-21 (ix), a
   4894 3A 80 5E      [13] 1439 	ld	a,(#(_g_player + 0x0004) + 0)
   4897 DD 77 ED      [19] 1440 	ld	-19 (ix), a
   489A 3A 7D 5E      [13] 1441 	ld	a,(#(_g_player + 0x0001) + 0)
   489D DD 77 EE      [19] 1442 	ld	-18 (ix), a
   48A0 DD 77 EE      [19] 1443 	ld	-18 (ix), a
   48A3 DD 36 EF 00   [19] 1444 	ld	-17 (ix), #0x00
   48A7 3A 7C 5E      [13] 1445 	ld	a,(#_g_player + 0)
   ...
   4950 FD 21 09 5F   [14] 1545 	ld	iy, #_g_framecounter
   ...
   49B3 CD 75 5D      [17] 1612 	call	_cpct_memset
   ...
   49C3 11 C1 5E      [10] 1626 	ld	de, #_g_projectiles
   49C6 19            [11] 1627 	add	hl, de
   49C7 C5            [11] 1628 	push	bc
   49C8 E5            [11] 1629 	push	hl
   49C9 CD 1B 5B      [17] 1630 	call	_projectilerender
   ...
   49DE 11 85 5E      [10] 1649 	ld	de, #_g_enemies
   49E1 19            [11] 1650 	add	hl, de
   49E2 C5            [11] 1651 	push	bc
   49E3 E5            [11] 1652 	push	hl
   49E4 CD 0A 56      [17] 1653 	call	_enemyrender
   ...
   49EF 3A 18 5F      [13] 1662 	ld	a,(#_g_bossactive + 0)
   49F2 B7            [ 4] 1663 	or	a, a
   49F3 28 58         [12] 1664 	jr	Z,00104$
                           1665 ;src/game.c:298: enemyrender(&g_boss);
   49F5 21 0E 5F      [10] 1666 	ld	hl, #_g_boss
   49F8 E5            [11] 1667 	push	hl
   49F9 CD 0A 56      [17] 1668 	call	_enemyrender
   ...
   4A00 CD 59 5D      [17] 1672 	call	_cpct_px2byteM0
   ...
   4A0D CD 4C 5E      [17] 1679 	call	_cpct_getScreenPtr
   ...
   4A1A CD 93 5D      [17] 1688 	call	_cpct_drawSolidBox
   ...
   4A20 3A 15 5F      [13] 1693 	ld	a, (#_g_boss + 7)
   ...
   4A2C CD 59 5D      [17] 1701 	call	_cpct_px2byteM0
   ...
   4A3B CD 4C 5E      [17] 1710 	call	_cpct_getScreenPtr
   ...
   4A57 CD 59 5D      [17] 1731 	call	_cpct_px2byteM0
   ...
   4A6F CD 4C 5E      [17] 1747 	call	_cpct_getScreenPtr
   ...
   4A97 CD 59 5D      [17] 1775 	call	_cpct_px2byteM0
   ...
   4AA4 CD 4C 5E      [17] 1782 	call	_cpct_getScreenPtr
   ...
   4AB1 CD 93 5D      [17] 1791 	call	_cpct_drawSolidBox
   ...
   4ABA CD 59 5D      [17] 1797 	call	_cpct_px2byteM0
   ...
   4AC7 CD 4C 5E      [17] 1804 	call	_cpct_getScreenPtr
   ...
   4AD4 CD 93 5D      [17] 1813 	call	_cpct_drawSolidBox
   ...
   4ADB 3A 08 5F      [13] 1820 	ld	a,(#_g_gameover + 0)
   ...
   4AE5 CD 59 5D      [17] 1826 	call	_cpct_px2byteM0
   ...
   4AF2 CD 4C 5E      [17] 1833 	call	_cpct_getScreenPtr
   ...
   4AFF CD 93 5D      [17] 1842 	call	_cpct_drawSolidBox
   ...
   4B08 CD 59 5D      [17] 1848 	call	_cpct_px2byteM0
   ...
   4B15 CD 4C 5E      [17] 1855 	call	_cpct_getScreenPtr
   ...
   4B22 CD 93 5D      [17] 1864 	call	_cpct_drawSolidBox
   ...
   4B29 3A 0D 5F      [13] 1871 	ld	a,(#_g_checkpointactive + 0)
   ...
   4B55 CD 93 5D      [17] 1899 	call	_cpct_drawSolidBox
