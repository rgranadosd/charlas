...
void enemyrender(const Enemy* enemy) {
    ...
    if (enemy->kind == 3) colour = cpct_px2byteM0(12, 12);
    else if (enemy->kind == 2) colour = cpct_px2byteM0(10, 10);
    else if (enemy->kind == 1) colour = cpct_px2byteM0(14, 14);
    else colour = cpct_px2byteM0(4, 4);
