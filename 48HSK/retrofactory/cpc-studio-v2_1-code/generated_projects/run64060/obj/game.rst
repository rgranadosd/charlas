   ...
   5F0B                      62 _g_timeleft:
   5F0B                      63 	.ds 1
   5F0C                      64 _g_weapondisplay:
   5F0C                      65 	.ds 1
   5F0D                      66 _g_currentwave:
   5F0D                      67 	.ds 1
   5F0E                      68 _g_aliveenemies:
   5F0E                      69 	.ds 1
   5F0F                      70 _g_wavecooldown:
   5F0F                      71 	.ds 1
   5F10                      72 _g_damagecooldown:
   5F10                      73 	.ds 1
   5F11                      74 _g_shootcooldown:
   5F11                      75 	.ds 1
   5F12                      76 _g_victory:
   5F12                      77 	.ds 1
   5F13                      78 _g_gameover:
   5F13                      79 	.ds 1
   5F14                      80 _g_framecounter:
   5F14                      81 	.ds 2
   5F16                      82 _g_checkpointx:
   5F16                      83 	.ds 1
   5F17                      84 _g_checkpointy:
   5F17                      85 	.ds 1
   5F18                      86 _g_checkpointactive:
   5F18                      87 	.ds 1
   5F19                      88 _g_boss:
   5F19                      89 	.ds 10
   5F23                      90 _g_bossactive:
   5F23                      91 	.ds 1
   5F24                      92 _g_bossphase:
   5F24                      93 	.ds 1
   5F25                      94 _g_weaponlevel:
   5F25                      95 	.ds 1
   5F26                      96 _g_pickuptaken:
   5F26                      97 	.ds 1
                             98 ;--------------------------------------------------------
                             99 ; ram data
                            100 ;--------------------------------------------------------
   ...
   4000 21 87 5E      [10]  128 	ld	hl, #_g_player
   4003 3A 16 5F      [13]  129 	ld	a,(#_g_checkpointx + 0)
   4006 77            [ 7]  130 	ld	(hl), a
                            131 ;src/game.c:43: g_player.y = g_checkpointy;
   4007 21 88 5E      [10]  132 	ld	hl, #(_g_player + 0x0001)
   400A 3A 17 5F      [13]  133 	ld	a,(#_g_checkpointy + 0)
   400D 77            [ 7]  134 	ld	(hl), a
                            135 ;src/game.c:44: g_player.vx = 0;
   400E 21 89 5E      [10]  136 	ld	hl, #(_g_player + 0x0002)
   4011 36 00         [10]  137 	ld	(hl), #0x00
                            138 ;src/game.c:45: g_player.vy = 0;
   4013 21 8A 5E      [10]  139 	ld	hl, #(_g_player + 0x0003)
   ...
   40B1 01 90 5E      [10]  235 	ld	bc, #_g_enemies+0
   ...
   40C4 CD EC 51      [17]  252 	call	_enemyinit
   ...
   4101                     294 00148$:
   4101 DD 73 FE      [19]  295 	ld	-2 (ix), e
   ...
   411A DD 7E FE      [19]  309 	ld	a, -2 (ix)
   ...
   418C CD 31 52      [17]  385 	call	_enemyspawn
   ...
   419E 32 0E 5F      [13]  396 	ld	(#_g_aliveenemies + 0),a
   ...
   41A6 21 19 5F      [10]  406 	ld	hl, #_g_boss
   41A9 E5            [11]  407 	push	hl
   41AA CD EC 51      [17]  408 	call	_enemyinit
   ...
   421F 11 CC 5E      [10]  487 	ld	de, #_g_projectiles
   ...
   422B 3A 25 5F      [13]  495 	ld	a,(#_g_weaponlevel + 0)
   ...
   423B                     502 00115$:
   423B 3A 88 5E      [13]  503 	ld	a, (#_g_player + 1)
   423E C6 06         [ 7]  504 	add	a, #0x06
   4240 DD 77 FD      [19]  505 	ld	-3 (ix), a
   4243 21 87 5E      [10]  506 	ld	hl, #_g_player + 0
   ...
   4254 11 CC 5E      [10]  518 	ld	de, #_g_projectiles
   ...
   4269 CD 10 5A      [17]  533 	call	_projectilefire
   ...
   4271 3A 25 5F      [13]  538 	ld	a,(#_g_weaponlevel + 0)
   ...
   427D                     545 00117$:
   427D 21 11 5F      [10]  546 	ld	hl,#_g_shootcooldown + 0
   ...
   4291 FD 21 08 5F   [14]  567 	ld	iy, #_g_lives
   ...
   42AD 21 10 5F      [10]  587 	ld	hl,#_g_damagecooldown + 0
   ...
   42D0 CD 7C 5C      [17]  614 	call	_cpct_setPALColour
   ...
   42DD CD 80 5D      [17]  623 	call	_cpct_memset
                            624 ;src/game.c:137: tilemap_init();
   42E0 CD 2A 50      [17]  625 	call	_tilemap_init
                            626 ;src/game.c:138: collision_init();
   42E3 CD 6E 4B      [17]  627 	call	_collision_init
                            628 ;src/game.c:139: playerinit(&g_player);
   42E6 21 87 5E      [10]  629 	ld	hl, #_g_player
   42E9 E5            [11]  630 	push	hl
   42EA CD E7 56      [17]  631 	call	_playerinit
   42ED F1            [10]  632 	pop	af
                            633 ;src/game.c:140: hudinit();
   42EE CD 7A 4E      [17]  634 	call	_hudinit
   ...
   42FB 11 CC 5E      [10]  646 	ld	de, #_g_projectiles
   42FE 19            [11]  647 	add	hl, de
   42FF C5            [11]  648 	push	bc
   4300 E5            [11]  649 	push	hl
   4301 CD CB 59      [17]  650 	call	_projectileinit
   ...
   43BB 21 87 5E      [10]  756 	ld	hl, #_g_player
   43BE E5            [11]  757 	push	hl
   43BF CD 27 57      [17]  758 	call	_playerupdate
   ...
   43C6 FD 21 11 5F   [14]  763 	ld	iy, #_g_shootcooldown
   ...
   43D3 FD 21 10 5F   [14]  770 	ld	iy, #_g_damagecooldown
   ...
   43EA 11 CC 5E      [10]  787 	ld	de, #_g_projectiles
   43ED 19            [11]  788 	add	hl, de
   43EE C5            [11]  789 	push	bc
   43EF E5            [11]  790 	push	hl
   43F0 CD C7 5A      [17]  791 	call	_projectileupdate
   ...
   4405 11 90 5E      [10]  810 	ld	de, #_g_enemies
   4408 19            [11]  811 	add	hl, de
   4409 C5            [11]  812 	push	bc
   440A E5            [11]  813 	push	hl
   440B CD 09 54      [17]  814 	call	_enemyupdate
   ...
   444E 21 19 5F      [10]  851 	ld	hl, #_g_boss + 0
   ...
   4464 3A 24 5F      [13]  862 	ld	a,(#_g_bossphase + 0)
   ...
   4475                     874 00183$:
   4475 3A 24 5F      [13]  875 	ld	a,(#_g_bossphase + 0)
   ...
   4481                     882 00188$:
   4481                     883 00184$:
   4481 21 1B 5F      [10]  884 	ld	hl, #(_g_boss + 0x0002)
   4484 71            [ 7]  885 	ld	(hl), c
                            886 ;src/game.c:196: enemyupdate(&g_boss);
   4485 21 19 5F      [10]  887 	ld	hl, #_g_boss
   4488 E5            [11]  888 	push	hl
   4489 CD 09 54      [17]  889 	call	_enemyupdate
   ...
   4498 21 CC 5E      [10]  904 	ld	hl, #_g_projectiles
   ...
   44BD 3E 90         [ 7]  928 	ld	a, #<(_g_enemies)
   44BF 85            [ 4]  929 	add	a, l
   44C0 DD 77 F7      [19]  930 	ld	-9 (ix), a
   44C3 3E 5E         [ 7]  931 	ld	a, #>(_g_enemies)
   44C5 8C            [ 4]  932 	adc	a, h
   44C6 DD 77 F8      [19]  933 	ld	-8 (ix), a
   44C9 DD 6E F7      [19]  934 	ld	l,-9 (ix)
   44CC DD 66 F8      [19]  935 	ld	h,-8 (ix)
   ...
   44EE DD 75 FB      [19]  952 	ld	-5 (ix), l
   44F1 DD 74 FC      [19]  953 	ld	-4 (ix), h
   ...
   44F8 DD 75 F9      [19]  957 	ld	-7 (ix), l
   44FB DD 74 FA      [19]  958 	ld	-6 (ix), h
   ...
   4503 DD 6E F7      [19]  964 	ld	l,-9 (ix)
   4506 DD 66 F8      [19]  965 	ld	h,-8 (ix)
   ...
   4512 DD 6E F7      [19]  973 	ld	l,-9 (ix)
   4515 DD 66 F8      [19]  974 	ld	h,-8 (ix)
   ...
   4520 DD 6E F7      [19]  981 	ld	l,-9 (ix)
   4523 DD 66 F8      [19]  982 	ld	h,-8 (ix)
   4526 23            [ 6]  983 	inc	hl
   4527 46            [ 7]  984 	ld	b, (hl)
   4528 DD 70 F0      [19]  985 	ld	-16 (ix), b
   452B DD 36 F1 00   [19]  986 	ld	-15 (ix), #0x00
   452F DD 6E F7      [19]  987 	ld	l,-9 (ix)
   4532 DD 66 F8      [19]  988 	ld	h,-8 (ix)
   ...
   454E DD 6E FB      [19] 1000 	ld	l,-5 (ix)
   4551 DD 66 FC      [19] 1001 	ld	h,-4 (ix)
   ...
   45A1 DD 6E F9      [19] 1040 	ld	l,-7 (ix)
   45A4 DD 66 FA      [19] 1041 	ld	h,-6 (ix)
   45A7 66            [ 7] 1042 	ld	h, (hl)
   45A8 DD 6E F7      [19] 1043 	ld	l, -9 (ix)
   45AB DD 46 F8      [19] 1044 	ld	b, -8 (ix)
   ...
   45B4 CD A7 56      [17] 1051 	call	_enemydamage
   ...
   45BF DD 6E F7      [19] 1060 	ld	l,-9 (ix)
   45C2 DD 66 F8      [19] 1061 	ld	h,-8 (ix)
   ...
   45D3 21 09 5F      [10] 1069 	ld	hl, #_g_score
   ...
   45E1 FD 21 0E 5F   [14] 1078 	ld	iy, #_g_aliveenemies
   ...
   4603 3A 23 5F      [13] 1098 	ld	a,(#_g_bossactive + 0)
   ...
   4615 21 1E 5F      [10] 1107 	ld	hl, #(_g_boss + 0x0005) + 0
   4618 46            [ 7] 1108 	ld	b, (hl)
   4619 3A 1D 5F      [13] 1109 	ld	a, (#(_g_boss + 0x0004) + 0)
   461C 21 1A 5F      [10] 1110 	ld	hl, #(_g_boss + 0x0001) + 0
   461F 6E            [ 7] 1111 	ld	l, (hl)
   4620 DD 75 E9      [19] 1112 	ld	-23 (ix), l
   4623 DD 36 EA 00   [19] 1113 	ld	-22 (ix), #0x00
   4627 21 19 5F      [10] 1114 	ld	hl, #_g_boss + 0
   ...
   464A DD 6E FB      [19] 1131 	ld	l,-5 (ix)
   464D DD 66 FC      [19] 1132 	ld	h,-4 (ix)
   ...
   4698 DD 6E F9      [19] 1172 	ld	l,-7 (ix)
   469B DD 66 FA      [19] 1173 	ld	h,-6 (ix)
   469E 46            [ 7] 1174 	ld	b, (hl)
   469F 11 19 5F      [10] 1175 	ld	de, #_g_boss
   46A2 C5            [11] 1176 	push	bc
   46A3 C5            [11] 1177 	push	bc
   46A4 33            [ 6] 1178 	inc	sp
   46A5 D5            [11] 1179 	push	de
   46A6 CD A7 56      [17] 1180 	call	_enemydamage
   ...
   46C5 21 12 5F      [10] 1203 	ld	hl,#_g_victory + 0
   ...
   46D1 3A 10 5F      [13] 1213 	ld	a,(#_g_damagecooldown + 0)
   ...
   46E7 01 90 5E      [10] 1228 	ld	bc,#_g_enemies
   ...
   4737 3A 8C 5E      [13] 1272 	ld	a,(#(_g_player + 0x0005) + 0)
   473A DD 77 ED      [19] 1273 	ld	-19 (ix), a
   473D 3A 8B 5E      [13] 1274 	ld	a,(#(_g_player + 0x0004) + 0)
   4740 DD 77 EE      [19] 1275 	ld	-18 (ix), a
   4743 3A 88 5E      [13] 1276 	ld	a, (#(_g_player + 0x0001) + 0)
   4746 DD 77 F0      [19] 1277 	ld	-16 (ix), a
   4749 DD 36 F1 00   [19] 1278 	ld	-15 (ix), #0x00
   474D 3A 87 5E      [13] 1279 	ld	a, (#_g_player + 0)
   4750 DD 77 F9      [19] 1280 	ld	-7 (ix), a
   4753 DD 36 FA 00   [19] 1281 	ld	-6 (ix), #0x00
   ...
   4771 DD 6E F9      [19] 1294 	ld	l,-7 (ix)
   4774 DD 66 FA      [19] 1295 	ld	h,-6 (ix)
   ...
   478C DD 34 E7      [23] 1310 	inc	-25 (ix)
   478F DD 7E E7      [19] 1311 	ld	a, -25 (ix)
   ...
   47BB 3A 8C 5E      [13] 1334 	ld	a,(#(_g_player + 0x0005) + 0)
   47BE DD 77 ED      [19] 1335 	ld	-19 (ix), a
   47C1 3A 8B 5E      [13] 1336 	ld	a,(#(_g_player + 0x0004) + 0)
   47C4 DD 77 EE      [19] 1337 	ld	-18 (ix), a
   47C7 3A 88 5E      [13] 1338 	ld	a, (#(_g_player + 0x0001) + 0)
   47CA DD 77 F0      [19] 1339 	ld	-16 (ix), a
   47CD DD 36 F1 00   [19] 1340 	ld	-15 (ix), #0x00
   47D1 3A 87 5E      [13] 1341 	ld	a, (#_g_player + 0)
   47D4 DD 77 F9      [19] 1342 	ld	-7 (ix), a
   47D7 DD 36 FA 00   [19] 1343 	ld	-6 (ix), #0x00
   ...
   47F2 DD 6E F9      [19] 1355 	ld	l,-7 (ix)
   47F5 DD 66 FA      [19] 1356 	ld	h,-6 (ix)
   ...
   480B 3A 10 5F      [13] 1369 	ld	a,(#_g_damagecooldown + 0)
   480E B7            [ 4] 1370 	or	a, a
   480F 20 31         [12] 1371 	jr	NZ,00149$
   4811 3A 8C 5E      [13] 1372 	ld	a, (#(_g_player + 0x0005) + 0)
   4814 21 8B 5E      [10] 1373 	ld	hl, #(_g_player + 0x0004) + 0
   4817 56            [ 7] 1374 	ld	d, (hl)
   4818 21 88 5E      [10] 1375 	ld	hl, #(_g_player + 0x0001) + 0
   481B 4E            [ 7] 1376 	ld	c, (hl)
   481C 06 00         [ 7] 1377 	ld	b, #0x00
   481E 21 87 5E      [10] 1378 	ld	hl, #_g_player + 0
   ...
   4835 CD C0 4C      [17] 1390 	call	_collision_is_on_trap
   ...
   4842 FD 21 18 5F   [14] 1401 	ld	iy, #_g_checkpointactive
   4846 FD 7E 00      [19] 1402 	ld	a, 0 (iy)
   4849 B7            [ 4] 1403 	or	a, a
   484A 20 1E         [12] 1404 	jr	NZ,00151$
   484C 3A 87 5E      [13] 1405 	ld	a, (#_g_player + 0)
   ...
   4857 21 16 5F      [10] 1411 	ld	hl,#_g_checkpointx + 0
   485A 36 34         [10] 1412 	ld	(hl), #0x34
                           1413 ;src/game.c:247: g_checkpointy = (u8)(tilemap_ground_y() - g_player.h);
   485C CD F7 50      [17] 1414 	call	_tilemap_ground_y
   485F 4D            [ 4] 1415 	ld	c, l
   4860 21 8C 5E      [10] 1416 	ld	hl, #(_g_player + 0x0005) + 0
   4863 46            [ 7] 1417 	ld	b, (hl)
   4864 21 17 5F      [10] 1418 	ld	hl, #_g_checkpointy
   ...
   486A 3A 26 5F      [13] 1424 	ld	a,(#_g_pickuptaken + 0)
   486D B7            [ 4] 1425 	or	a, a
   486E C2 FD 48      [10] 1426 	jp	NZ, 00154$
   4871 CD F7 50      [17] 1427 	call	_tilemap_ground_y
   ...
   488E 3A 8C 5E      [13] 1437 	ld	a,(#(_g_player + 0x0005) + 0)
   4891 DD 77 EB      [19] 1438 	ld	-21 (ix), a
   4894 3A 8B 5E      [13] 1439 	ld	a,(#(_g_player + 0x0004) + 0)
   4897 DD 77 ED      [19] 1440 	ld	-19 (ix), a
   489A 3A 88 5E      [13] 1441 	ld	a,(#(_g_player + 0x0001) + 0)
   489D DD 77 EE      [19] 1442 	ld	-18 (ix), a
   48A0 DD 77 EE      [19] 1443 	ld	-18 (ix), a
   48A3 DD 36 EF 00   [19] 1444 	ld	-17 (ix), #0x00
   48A7 3A 87 5E      [13] 1445 	ld	a,(#_g_player + 0)
   ...
   4950 FD 21 14 5F   [14] 1545 	ld	iy, #_g_framecounter
   ...
   49B3 CD 80 5D      [17] 1612 	call	_cpct_memset
                           1613 ;src/game.c:287: tilemap_render();
   49B6 CD 56 50      [17] 1614 	call	_tilemap_render
   ...
   49C3 11 CC 5E      [10] 1626 	ld	de, #_g_projectiles
   49C6 19            [11] 1627 	add	hl, de
   49C7 C5            [11] 1628 	push	bc
   49C8 E5            [11] 1629 	push	hl
   49C9 CD 26 5B      [17] 1630 	call	_projectilerender
   ...
   49DE 11 90 5E      [10] 1649 	ld	de, #_g_enemies
   49E1 19            [11] 1650 	add	hl, de
   49E2 C5            [11] 1651 	push	bc
   49E3 E5            [11] 1652 	push	hl
   49E4 CD 15 56      [17] 1653 	call	_enemyrender
   ...
   49EF 3A 23 5F      [13] 1662 	ld	a,(#_g_bossactive + 0)
   49F2 B7            [ 4] 1663 	or	a, a
   49F3 28 58         [12] 1664 	jr	Z,00104$
                           1665 ;src/game.c:298: enemyrender(&g_boss);
   49F5 21 19 5F      [10] 1666 	ld	hl, #_g_boss
   49F8 E5            [11] 1667 	push	hl
   49F9 CD 15 56      [17] 1668 	call	_enemyrender
   ...
   4A00 CD 64 5D      [17] 1672 	call	_cpct_px2byteM0
   ...
   4A0D CD 57 5E      [17] 1679 	call	_cpct_getScreenPtr
   ...
   4A1A CD 9E 5D      [17] 1688 	call	_cpct_drawSolidBox
   ...
   4A20 3A 20 5F      [13] 1693 	ld	a, (#_g_boss + 7)
   ...
   4A2C CD 64 5D      [17] 1701 	call	_cpct_px2byteM0
   ...
   4A3B CD 57 5E      [17] 1710 	call	_cpct_getScreenPtr
   ...
   4A57 CD 64 5D      [17] 1731 	call	_cpct_px2byteM0
   4A5A 55            [ 4] 1732 	ld	d, l
   4A5B D5            [11] 1733 	push	de
   4A5C CD F7 50      [17] 1734 	call	_tilemap_ground_y
   ...
   4A6F CD 57 5E      [17] 1747 	call	_cpct_getScreenPtr
   ...
   4A97 CD 64 5D      [17] 1775 	call	_cpct_px2byteM0
   ...
   4AA4 CD 57 5E      [17] 1782 	call	_cpct_getScreenPtr
   ...
   4AB1 CD 9E 5D      [17] 1791 	call	_cpct_drawSolidBox
   ...
   4ABA CD 64 5D      [17] 1797 	call	_cpct_px2byteM0
   ...
   4AC7 CD 57 5E      [17] 1804 	call	_cpct_getScreenPtr
   ...
   4AD4 CD 9E 5D      [17] 1813 	call	_cpct_drawSolidBox
   ...
   4ADB 3A 13 5F      [13] 1820 	ld	a,(#_g_gameover + 0)
   ...
   4AE5 CD 64 5D      [17] 1826 	call	_cpct_px2byteM0
   ...
   4AF2 CD 57 5E      [17] 1833 	call	_cpct_getScreenPtr
   ...
   4AFF CD 9E 5D      [17] 1842 	call	_cpct_drawSolidBox
   ...
   4B08 CD 64 5D      [17] 1848 	call	_cpct_px2byteM0
   ...
   4B15 CD 57 5E      [17] 1855 	call	_cpct_getScreenPtr
   ...
   4B22 CD 9E 5D      [17] 1864 	call	_cpct_drawSolidBox
   ...
   4B29 3A 18 5F      [13] 1871 	ld	a,(#_g_checkpointactive + 0)
   ...
   4B55 CD 9E 5D      [17] 1899 	call	_cpct_drawSolidBox
