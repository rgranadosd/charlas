   ...
   5F2D                      29 _ginputleft:
   5F2D                      30 	.ds 1
   5F2E                      31 _ginputright:
   5F2E                      32 	.ds 1
   5F2F                      33 _ginputup:
   5F2F                      34 	.ds 1
   5F30                      35 _ginputdown:
   5F30                      36 	.ds 1
   5F31                      37 _ginputshoot:
   5F31                      38 	.ds 1
   5F32                      39 _gprevjump:
   5F32                      40 	.ds 1
   5F33                      41 _gprevshoot:
   ...
   4F85 3A 2F 5F      [13]   73 	ld	a,(#_ginputup + 0)
   4F88 32 32 5F      [13]   74 	ld	(#_gprevjump + 0),a
                             75 ;src/systems/input.c:13: gprevshoot = ginputshoot;
   4F8B 3A 31 5F      [13]   76 	ld	a,(#_ginputshoot + 0)
   4F8E 32 33 5F      [13]   77 	ld	(#_gprevshoot + 0),a
                             78 ;src/systems/input.c:14: cpct_scanKeyboard_f();
   4F91 CD FB 5B      [17]   79 	call	_cpct_scanKeyboard_f
                             80 ;src/systems/input.c:15: ginputleft = cpct_isKeyPressed(Key_CursorLeft);
   4F94 21 01 01      [10]   81 	ld	hl, #0x0101
   4F97 CD EF 5B      [17]   82 	call	_cpct_isKeyPressed
   4F9A FD 21 2D 5F   [14]   83 	ld	iy, #_ginputleft
   ...
   4FA4 CD EF 5B      [17]   87 	call	_cpct_isKeyPressed
   4FA7 FD 21 2E 5F   [14]   88 	ld	iy, #_ginputright
   ...
   4FB1 CD EF 5B      [17]   92 	call	_cpct_isKeyPressed
   4FB4 FD 21 2F 5F   [14]   93 	ld	iy, #_ginputup
   ...
   4FBE CD EF 5B      [17]   97 	call	_cpct_isKeyPressed
   4FC1 FD 21 30 5F   [14]   98 	ld	iy, #_ginputdown
   ...
   4FCB CD EF 5B      [17]  102 	call	_cpct_isKeyPressed
   4FCE FD 21 31 5F   [14]  103 	ld	iy, #_ginputshoot
   ...
   4FD6 FD 21 2D 5F   [14]  112 	ld	iy, #_ginputleft
   ...
   4FDE FD 21 2E 5F   [14]  121 	ld	iy, #_ginputright
   ...
   4FE6 FD 21 2F 5F   [14]  130 	ld	iy, #_ginputup
   ...
   4FEE FD 21 30 5F   [14]  139 	ld	iy, #_ginputdown
   ...
   4FF6 FD 21 2F 5F   [14]  148 	ld	iy, #_ginputup
   ...
   4FFE 3A 2F 5F      [13]  157 	ld	a,(#_ginputup + 0)
   5001 B7            [ 4]  158 	or	a, a
   5002 28 06         [12]  159 	jr	Z,00103$
   5004 3A 32 5F      [13]  160 	ld	a,(#_gprevjump + 0)
   ...
   5010 FD 21 31 5F   [14]  175 	ld	iy, #_ginputshoot
   ...
   5018 3A 31 5F      [13]  184 	ld	a,(#_ginputshoot + 0)
   501B B7            [ 4]  185 	or	a, a
   501C 28 06         [12]  186 	jr	Z,00103$
   501E 3A 33 5F      [13]  187 	ld	a,(#_gprevshoot + 0)
